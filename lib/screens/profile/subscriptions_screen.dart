...
class _SubscriptionsPageState extends State<SubscriptionsPage> with TickerProviderStateMixin {
  ...
  Future<void> _handleSuccessfulPurchase(PurchaseDetails purchaseDetails) async {
    ...
    await prefs.setString('vip_type', vipType);
          _showSnackBar("Foka Premium activated!");
  ...
  Future<void> _restorePurchases() async {
    ...
    try {
      ...
      if (_isVip) {
        _showSnackBar("Purchases restored successfully! Foka Premium activated.");
      } else {
                          ...
                          children: [
                            ...
                            if (_isVip && _vipExpiry != null) ...[
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    const Icon(Icons.star, color: AppColors.background, size: 28),
