...
class DataPersistenceService {
  ...
  // 保存聊天消息
  static Future<void> saveMessages(String aiRoleId, List<ConversationEntity> messages) async {
    try {
  ...
  // 加载聊天消息
  static Future<List<ConversationEntity>> loadMessages(String aiRoleId) async {
    try {
      final prefs = await SharedPreferences.getInstance();
