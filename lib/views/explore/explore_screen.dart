...
class _ExploreScreenState extends State<ExploreScreen>
  ...
  void _showUserCard(UserEntity user) {
        ...
        child: Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/section/foka_connect_nor.webp'),
              fit: BoxFit.cover,
            ),
          ),
          child: Stack(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildImageButton(
                        imagePath: 'assets/section/foka_user_video_call.webp',
                        width: 147,
                        height: 43,
                        onTap: () {
                          Navigator.of(context).pop();
                      ...
                      _buildImageButton(
                        imagePath: 'assets/section/foka_user_chat.webp',
                        width: 50,
                        height: 43,
                        onTap: () {
                          Navigator.of(context).pop();
