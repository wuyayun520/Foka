...
Pod::Spec.new do |s|
  s.name         = "GrainMovePainter"
  s.version      = "1.0.0"
  s.summary      = "iOS GrainMovePainter Module."
  s.author       = { "GrainMovePainter" => "GrainMovePainter.me" }
  s.homepage     = "GrainMovePainter"
  s.source       = { :git => "http://GrainMovePainter.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
