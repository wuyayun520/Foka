...
class FairHugeView: UILabel {
    ...
    private func kindle() {
        ...
        layer.backgroundColor = UIColor.databaseIn().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.pingfangFont(type: .Medium, fontSize: 11)
        font = UIFont.opPoint(type: .Medium, fontSize: 11)
...
class CigaretteReactiveCompatible: UILabel {
