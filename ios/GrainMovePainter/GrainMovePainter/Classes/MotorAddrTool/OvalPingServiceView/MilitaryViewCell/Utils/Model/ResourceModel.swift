...
//: @objcMembers public class ResourceModel: JSONModel {
@objcMembers public class ResourceModel: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = AlsoMpDefaultsSerializable.Face
...
//: @objc extension ResourceModel {
@objc extension ResourceModel {
    //: func initWith(suiteType: BeautyItemType)-> ResourceModel {
    func flatWrite(suiteType: AlsoMpDefaultsSerializable) -> ResourceModel {
        //: let model = ResourceModel.init()
