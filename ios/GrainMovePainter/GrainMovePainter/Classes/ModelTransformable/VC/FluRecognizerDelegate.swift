...
class FluRecognizerDelegate: BodyLatViewController {
    ...
    lazy var topView: CrimsonTopView = {
        //: let view = TalkingMomentPhotosTopView(frame: CGRect.zero, type: myType ?? .normal)
        let view = CrimsonTopView(frame: CGRect.zero, type: myType ?? .normal)
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var bottomView: GroundBeatView = {
    ...
    lazy var usePhotoView: HemReactiveCompatible = {
        //: let v = TalkingSendIntimateInfoView(frame: CGRect.zero, type: .intimatePhoto)
        let v = HemReactiveCompatible(frame: CGRect.zero, type: .intimatePhoto)
        //: return v
        return v
        //: }()
    }()
...
extension FluRecognizerDelegate {
    //: func crushBtnTool(modle: TalkingMomentModel) {
    func plowAcross(modle: ContentTheoryDialogMeasurable) {
        ...
        if modle.sex == nil {
            ...
            //: bottomView.isHidden = modle.sex==SteppingMotorThen.share.loginUserMode.sex
            bottomView.isHidden = modle.sex == SteppingMotorThen.share.loginUserMode.sex
        }
