...
fileprivate let noti_lateEdgeFormat:[UInt8] = [0xe9,0xee,0xe9,0xf4,0xa8,0xe3,0xef,0xe4,0xe5,0xf2,0xba,0xa9,0xa0,0xe8,0xe1,0xf3,0xa0,0xee,0xef,0xf4,0xa0,0xe2,0xe5,0xe5,0xee,0xa0,0xe9,0xed,0xf0,0xec,0xe5,0xed,0xe5,0xee,0xf4,0xe5,0xe4]

private func afterwardActivity(knock num: UInt8) -> UInt8 {
    return num ^ 128
}
...
class HangThen: UICollectionView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_lateEdgeFormat.map{afterwardActivity(knock: $0)}, encoding: .utf8)!)
    }

    //: func configModel(model: TalkingMomentModel) {
    func appModel(model: ContentTheoryDialogMeasurable) {
        //: cunrrenModel = model
        cunrrenModel = model
        //: self.reloadData()
        self.reloadData()
...
extension HangThen: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_: UICollectionView, layout _: UICollectionViewLayout, insetForSectionAt _: Int) -> UIEdgeInsets {
        ...
        if cunrrenModel.pic.count == 4 {
            ...
            return UIEdgeInsets(top: 0, left: 0, bottom: 0, right: dataShowDetailPopMessage - 200 - 30)
    ...
    func collectionView(_: UICollectionView, layout _: UICollectionViewLayout, sizeForItemAt _: IndexPath) -> CGSize {
        ...
        if cunrrenModel.pic.count == 1 {
            ...
            var width = isMyhost ? (dataShowDetailPopMessage - 30 - 24 - 30) / 3 : (dataShowDetailPopMessage - 30 - 24) / 3
    ...
    func collectionView(_: UICollectionView, layout _: UICollectionViewLayout, referenceSizeForHeaderInSection _: Int) -> CGSize {
        ...
        return CGSize(width: dataShowDetailPopMessage, height: 1)
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell: CommentFormPhotosCell = collectionView.dequeueReusableCell(withReuseIdentifier: CommentFormPhotosCell.className(), for: indexPath) as! CommentFormPhotosCell
        //: let model: TalkingMomentPhotoModel = cunrrenModel.pic[indexPath.row]
        let model: GenreModelType = cunrrenModel.pic[indexPath.row]
        //: cell.configUrl(url: model.thumbUrl ?? "")
        cell.housework(url: model.thumbUrl ?? "")
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let vc = ControlDataSource(momentModel: cunrrenModel, index: indexPath.row, type: .normal)
...
extension HangThen {
    ...
    private func forageOrSubviews() {
        //: backgroundColor = .clear
        backgroundColor = .clear
        //: register(TalkingMomentPhotosCell.self, forCellWithReuseIdentifier: TalkingMomentPhotosCell.className())
        register(CommentFormPhotosCell.self, forCellWithReuseIdentifier: CommentFormPhotosCell.className())
        //: dataSource = self
        dataSource = self
        //: delegate = self
        delegate = self
