...
fileprivate let noti_portKey:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_lounge" :*/
fileprivate let mainOrientationName:[Character] = ["i","c","o","n","_","l","o"]
fileprivate let data_admissionKey:String = "urequirege"

/*: "#777777" :*/
fileprivate let userChanceUrl:String = "#covercovercovercovercovercover"

/*: "UID: :*/
fileprivate let mainSunKey:String = "delay little security outside weeUID:"
...
// __CLOSE_PRINT__
//
//  MyPocketReactiveCompatible.swift
//  AbroadTalking
//
...
class MyPocketReactiveCompatible: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_portKey.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.hr(name: (String(mainOrientationName) + data_admissionKey.replacingOccurrences(of: "require", with: "n")))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.font = UIFont.opPoint(type: .Regular, fontSize: 15)
        //: lab.textColor = UIColor(hex: "#777777")
        lab.textColor = UIColor(hex: (userChanceUrl.replacingOccurrences(of: "cover", with: "7")))
        //: return lab
        return lab
        //: }()
    }()
...
extension MyPocketReactiveCompatible {
    /// 刷新
    //: func refreshCell(model: TalkingRecommendUserModel) {
    func representative(model: BeatUserModel) {
        //: headPicImgV.setUrlImage(urlStr: model.headPic)
        headPicImgV.underStack(urlStr: model.headPic)
        //: nicknameLab.textColor = model.loungePlus ? .userVipColor():.appTitleColor()
        nicknameLab.textColor = model.loungePlus ? .colorObserver() : .quitTo()
        //: nicknameLab.text = model.nickname
        nicknameLab.text = model.nickname
        //: uidLab.text = "UID:\(model.uid)"
        uidLab.text = (String(mainSunKey.suffix(4))) + "\(model.uid)"
