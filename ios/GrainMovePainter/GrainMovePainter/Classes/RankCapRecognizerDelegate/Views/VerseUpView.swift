...
fileprivate let appDateMsg:[UInt8] = [0x2c,0x31,0x2c,0x37,0xeb,0x26,0x32,0x27,0x28,0x35,0xfd,0xec,0xe3,0x2b,0x24,0x36,0xe3,0x31,0x32,0x37,0xe3,0x25,0x28,0x28,0x31,0xe3,0x2c,0x30,0x33,0x2f,0x28,0x30,0x28,0x31,0x37,0x28,0x27]

fileprivate func tillQuery(park num: UInt8) -> UInt8 {
...
/*: "iv_Guidance" :*/
fileprivate let noti_glassHandleMsg:[Character] = ["i","v","_","G","u","i","d","a","n","c","e"]

/*: "Click to view" :*/
fileprivate let mainCigaretteId:String = "gesture messageCl"
fileprivate let app_debateValue:String = "angle area adjustick to"
...
class VerseUpView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: appDateMsg.map{tillQuery(park: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIImageView = {
        ...
        iamg.image = UIImage.hr(name: (String(noti_glassHandleMsg)))
    ...
    private lazy var clickToViewBtn: UIButton = {
        ...
        btn.setTitle((String(mainCigaretteId.suffix(2)) + String(app_debateValue.suffix(6)) + " view").localized, for: .normal)
