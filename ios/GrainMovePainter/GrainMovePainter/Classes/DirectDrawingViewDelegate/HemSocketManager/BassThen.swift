...
/*: "App" :*/
fileprivate let appButtBoxId:String = "tag split notice pingApp"

/*: "blockList_ :*/
fileprivate let userShotKey:String = "provider direct numberblockL"
fileprivate let user_pictureMsg:[Character] = ["i","s","t","_"]
...
class BassThen: NSObject {
    ...
    func blockId(userId: String) -> Bool {
    ...
    private func someoneFun() -> String {
        //: let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        //: let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent("App")
        let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent((String(appButtBoxId.suffix(3))))
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((String(userShotKey.suffix(6)) + String(user_pictureMsg)) + "\(uid)")
        //: return filePath
        return filePath
    }
}
