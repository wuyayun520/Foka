...
open class ReliableTextView: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = ReliableTextView.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
    ...
    private func unlinedInit() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(betweenObject),
    ...
    private func appearEditConstraint() {
    ...
    @objc private func betweenObject() {
