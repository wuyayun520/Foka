...
fileprivate let constBeatMsg:[UInt8] = [0x3b,0x3c,0x3b,0x26,0x7a,0x31,0x3d,0x36,0x37,0x20,0x68,0x7b,0x72,0x3a,0x33,0x21,0x72,0x3c,0x3d,0x26,0x72,0x30,0x37,0x37,0x3c,0x72,0x3b,0x3f,0x22,0x3e,0x37,0x3f,0x37,0x3c,0x26,0x37,0x36]

private func clubTractRemain(record num: UInt8) -> UInt8 {
    return num ^ 82
}

/*: "#292929" :*/
fileprivate let notiCancelMessage:String = "#292929"

/*: "9999999" :*/
fileprivate let userBookReloadValue:String = "beyond"
fileprivate let notiAlongPath:String = "spendspend9"

/*: "icon_coin" :*/
fileprivate let constDescriptionFormat:String = "icon_rem two"
fileprivate let main_lackName:String = "referoin"

/*: "icon_gift_more_arrow" :*/
fileprivate let mainMaybeKey:String = "topic electronic res slow costicon_g"
fileprivate let k_promptValue:String = "ore_arrowimagination transfer"

/*: "Hot" :*/
fileprivate let constResolveValue:[Character] = ["H","o","t"]

/*: "VIP" :*/
fileprivate let app_actionPath:String = "VviewP"

/*: "Bags" :*/
fileprivate let user_tempName:String = "Bagsadd dynamic properly orientation"

/*: "icon_gift_num_arrow" :*/
fileprivate let notiThemeAlwaysId:[Character] = ["i","c","o","n","_","g","i","f","t","_","n","u","m","_","a","r","r"]
fileprivate let kHurryId:String = "obook"

/*: "Send" :*/
fileprivate let constMobileObtainStr:String = "write over blastSend"

/*: "nav_back_black_nor" :*/
fileprivate let const_activePlyFullValue:[Character] = ["n","a","v","_","b","a"]
fileprivate let k_accuracyName:String = "expected"
fileprivate let user_automaticStr:[Character] = ["k","_","b","l","a","c","k","_","n","o","r"]

/*: "The number of gifts cannot be less than 1" :*/
fileprivate let k_frameStr:[UInt8] = [0xcc,0xf0,0xfd,0xb8,0xf6,0xed,0xf5,0xfa,0xfd,0xea,0xb8,0xf7,0xfe,0xb8,0xff,0xf1,0xfe,0xec,0xeb,0xb8,0xfb,0xf9,0xf6,0xf6,0xf7,0xec,0xb8,0xfa,0xfd,0xb8,0xf4,0xfd,0xeb,0xeb,0xb8,0xec,0xf0,0xf9,0xf6,0xb8,0xa9]

private func countIon(early num: UInt8) -> UInt8 {
    return num ^ 152
}

/*: "Please select a gift" :*/
fileprivate let app_formerMessage:[Character] = ["P","l","e","a","s","e"," ","s","e","l","e","c","t"," ","a"," ","g"]
fileprivate let dataMaterialMessage:[Character] = ["i","f","t"]

/*: "Please select an object" :*/
fileprivate let k_cutOthersMsg:String = "Pleasefollowing them electric"
fileprivate let dataSpotScrambleMsg:String = "ct acommunication data assist"
fileprivate let user_numbDragContactId:[Character] = ["c","t"]

/*: "Select the desired gift to unlock" :*/
fileprivate let showCoordinateName:[UInt8] = [0x6b,0x63,0x6f,0x6c,0x6e,0x75,0x20,0x6f,0x74,0x20,0x74,0x66,0x69,0x67,0x20,0x64,0x65,0x72,0x69,0x73,0x65,0x64,0x20,0x65,0x68,0x74,0x20,0x74,0x63,0x65,0x6c,0x65,0x53]

/*: "Select object >" :*/
fileprivate let showMakerToneStr:String = "Selectper tail time"
fileprivate let user_flagStr:String = "ct >ally missing"

/*: "It looks like there's nothing" :*/
fileprivate let main_failMessage:String = "It lblind into bag empty just"
fileprivate let showModestMaxValue:String = "libye"
fileprivate let main_serverMessage:[Character] = ["n","o","t","h","i","n","g"]

/*: "FF75A4" :*/
fileprivate let data_helpFormat:String = "screen"
fileprivate let kSpendFormat:String = "F75Ainterrupt"

/*: "E570FF" :*/
fileprivate let noti_edgeStr:String = "E5distinguishFF"

/*: "Ask for" :*/
fileprivate let app_advertisingHarvestText:[Character] = ["A","s","k"," ","f","o","r"]

/*: " Select %@ > " :*/
fileprivate let k_giftPath:[Character] = [" ","S","e","l","e","c","t"," ","%","@"," ",">"," "]

/*: "All Numbers" :*/
fileprivate let dataQuantityervalStr:[Character] = ["A","l","l"," ","N"]
fileprivate let constLandValue:[Character] = ["u","m","b","e","r","s"]

/*: "View detailed description >" :*/
fileprivate let mainStartKey:String = "Viewcharacter heel jar official follow"
fileprivate let notiAwakeContent:String = "aspect white alive spot catchailed des"
fileprivate let const_clingName:String = "cmotivationipt"

/*: "9999" :*/
fileprivate let notiRoundTitle:String = "rererere"

/*: "Custom" :*/
fileprivate let userNetworkStr:[Character] = ["C","u","s","t","o","m"]

/*: "mf_coin" :*/
fileprivate let data_standardMessage:String = "number sound facemf_co"
fileprivate let dataDepthContent:String = "transactionn"

/*: "showBagsRed" :*/
fileprivate let dataCellMsg:[Character] = ["s","h","o","w","B"]
fileprivate let main_femaleData:[Character] = ["a","g","s","R","e","d"]
...
// __CLOSE_PRINT__
//
//  PerCentumReactiveCompatible.swift
//  AbroadTalking
//
...
enum ThereQuickLookable: String {
    //: case normal = "0"          // 默认送礼
    case normal = "0" // 默认送礼
...
enum DoweryTermConvertible: Int {
    //: case Hot = 0
    case Hot = 0 // 默认礼物
    //: case Vip = 1
    case Vip = 1 // vip礼物
...
typealias SendFunctionBlock = (_ giftModel: MyGiftModel, _ num: String) -> Void
// 索要礼物Block
//: typealias AskforFunctionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String) -> Void
typealias AskforFunctionBlock = (_ giftModel: MyGiftModel, _ num: String) -> Void
// 私密照片发送礼物Block
//: typealias OKButtonBlock = (_ giftModel: TalkingRoomGiftModel) -> Void
typealias OKButtonBlock = (_ giftModel: MyGiftModel) -> Void
// 群聊发送礼物Block
//: typealias ChatRoomSendActionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String, _ model: TalkingChatRoomMemberModel) -> Void
typealias ChatRoomSendActionBlock = (_ giftModel: MyGiftModel, _ num: String, _ model: StatusStrokeModelType) -> Void
// 隐藏礼物面板Block
...
private let mainLogPath = 44.0
//: let GiftScrollContentView_H = 252.0
let app_outputMessage = 252.0
//: private let pageControl_H = 7.0
private let kAddKey = 7.0
//: private let bottomView_H = 44.0
private let const_beginMsg = 44.0

//: class TalkingChatGiftView: UIView {
class PerCentumReactiveCompatible: UIView {
    //: var chatRoomID = ""
    var chatRoomID = ""
    ...
    var contentHeight = mainLogPath + app_outputMessage + kAddKey + const_beginMsg + k_depthUrl
    //: var keyborHeight = 0
    var keyborHeight = 0
    ...
    private var style: ThereQuickLookable = .normal
    ...
    var chatRoomgiftSelectedMemberModel: StatusStrokeModelType?
    //: var popView: TalkingPopView?
    var popView: WalkReactiveCompatible?
    //: var meneView = DropDownMemberMenuView()
    var meneView = HappeningViewDelegate()
    ...
    private var titlesArr = [DoweryTermConvertible]()
    // 当前选中数据类型
    //: private var currType = GiftDataType.Hot
    private var currType = DoweryTermConvertible.Hot
    ...
    init(frame: CGRect = .zero, style: ThereQuickLookable = .normal, titlesArr: [DoweryTermConvertible] = [.Hot, .Vip, .Bags]) {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constBeatMsg.map{clubTractRemain(record: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIView = {
        ...
        let frame = CGRect(x: 0, y: dataViewPath, width: dataShowDetailPopMessage, height: contentHeight)
        //: let content = UIView(frame: frame)
        let content = UIView(frame: frame)
        //: content.backgroundColor = .init(hex: "#292929")
        content.backgroundColor = .init(hex: (notiCancelMessage.capitalized))
        //: content.Corner(width: ScreenWidth, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        content.vernalEquinox(width: dataShowDetailPopMessage, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
    ...
    private lazy var topView: UIView = {
        ...
        let frame = CGRect(x: 0, y: 0, width: dataShowDetailPopMessage, height: mainLogPath)
        //: let view = UIView(frame: frame)
        let view = UIView(frame: frame)
        //: view.backgroundColor = .init(hex: "#292929")
        view.backgroundColor = .init(hex: (notiCancelMessage.capitalized))
    ...
    private lazy var moneyBtn: MagnitudeercalateTalkingButton = {
        //: let btn = TalkingButton()
        let btn = MagnitudeercalateTalkingButton()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Medium, fontSize: 14)
        btn.titleLabel?.font = UIFont.opPoint(type: .Medium, fontSize: 14)
        //: btn.setTitle("9999999", for: .normal)
        btn.setTitle((userBookReloadValue.replacingOccurrences(of: "beyond", with: "99") + notiAlongPath.replacingOccurrences(of: "spend", with: "99")), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_coin"), for: .normal)
        btn.setImage(UIImage.hr(name: (String(constDescriptionFormat.prefix(5)) + main_lackName.replacingOccurrences(of: "refer", with: "c"))), for: .normal)
    ...
    private lazy var indicatorImage: UIImageView = {
        ...
        img.image = UIImage.hr(name: (String(mainMaybeKey.suffix(6)) + "ift_m" + String(k_promptValue.prefix(9))))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var pageControl: UIPageControl = {
        ...
        page.currentPageIndicatorTintColor = UIColor.detergentSaveer(180, 180, 180, 1)
        //: page.pageIndicatorTintColor = UIColor.RGBA(60, 60, 60, 1)
        page.pageIndicatorTintColor = UIColor.detergentSaveer(60, 60, 60, 1)
    ...
    private lazy var hotGiftCollectionView: UICollectionView = {
        ...
        hot.register(AttributeRequestReactiveCompatible.self, forCellWithReuseIdentifier: AttributeRequestReactiveCompatible.className())
        //: return hot
        return hot
        //: }()
    }()
    ...
    private lazy var hotGiftLayout: MoveThen = //: return hotGiftCollectionView.collectionViewLayout as! MoveThen
        hotGiftCollectionView.collectionViewLayout as! MoveThen
    //: }()
    ...
    private lazy var titleScrollView: ViewReactiveCompatible = {
        //: var titles = [String]()
        var titles = [String]()
        ...
        titlesArr.forEach { type in
            ...
            case .Hot:
                ...
                titles.append((String(constResolveValue)).localized)
            //: case .Vip:
            case .Vip:
                //: titles.append("VIP".localized)
                titles.append((app_actionPath.replacingOccurrences(of: "view", with: "I")).localized)
            //: case .Bags:
            case .Bags:
                //: titles.append("Bags".localized)
                titles.append((String(user_tempName.prefix(4))).localized)
            }
        }
        //: var style = SegmentStyle()
        var style = NoticeSegmentStyle()
        ...
        let scrollview = ViewReactiveCompatible(frame: CGRect(x: 0, y: 0, width: titlesArr.count * 50, height: Int(mainLogPath)), segmentStyle: style, titles: titles)
        //: if LanguageManager.shared.direction == .rightToLeft {
        if LieLanguageManager.shared.direction == .rightToLeft {
            //: scrollview.frame.origin.x = DetermineJoinReactiveCompatible.getScreenWidth()-scrollview.frame.width
            scrollview.frame.origin.x = DetermineJoinReactiveCompatible.mobileBass() - scrollview.frame.width
        }
        // 点击标题，联动礼物面板
        ...
        scrollview.redBagsLab.isHidden = !HimGiftManager.share.showBagsRed
        //: return scrollview
        return scrollview
        //: }()
    }()
    ...
    private lazy var giftNumButton: MagnitudeercalateTalkingButton = {
        ...
        btn.setImage(UIImage.hr(name: (String(notiThemeAlwaysId) + kHurryId.replacingOccurrences(of: "book", with: "w"))), for: .normal)
        //: btn.imageAlignment = .right
        btn.imageAlignment = .right
        //: btn.spaceBetweenTitleAndImage = 4
        btn.spaceBetweenTitleAndImage = 4
        //: btn.addTarget(self, action: #selector(giftNumBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(alter), for: .touchUpInside)
    ...
    private lazy var sendButton: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.opPoint(type: .Semibold, fontSize: 15)
        //: btn.backgroundColor = UIColor.appThemeColor()
        btn.backgroundColor = UIColor.nameure()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.setTitle("Send".localized, for: .normal)
        btn.setTitle((String(constMobileObtainStr.suffix(4))).localized, for: .normal)
        //: btn.addTarget(self, action: #selector(onTouchSendGiftBtn), for: .touchUpInside)
        btn.addTarget(self, action: #selector(quantityerrupt), for: .touchUpInside)
    ...
    private lazy var giftInputNumInputView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: dataViewPath - CGFloat(keyborHeight) - 44, width: dataShowDetailPopMessage, height: 44))
        //: view.backgroundColor = .black
        view.backgroundColor = .black
        //: let backButton = UIButton.init()
        let backButton = UIButton()
        //: let img = UIImage.BundleImageNamed(name: "nav_back_black_nor").withRenderingMode(.alwaysTemplate)
        let img = UIImage.hr(name: (String(const_activePlyFullValue) + k_accuracyName.replacingOccurrences(of: "expected", with: "c") + String(user_automaticStr))).withRenderingMode(.alwaysTemplate)
        ...
        sendButton.micState(color: .nameure(), forState: .normal)
        //: sendButton.setTitleColor(UIColor.white, for: .normal)
        sendButton.setTitleColor(UIColor.white, for: .normal)
        //: sendButton.setTitle("Send".localized, for: .normal)
        sendButton.setTitle((String(constMobileObtainStr.suffix(4))).localized, for: .normal)
        ...
        sendButton.rx.tap.subscribe { [weak self] _ in
            ...
            guard Int(str) ?? 0 >= 1 else {
                ...
                self.revenueMsg(showMsg: String(bytes: k_frameStr.map{countIon(early: $0)}, encoding: .utf8)!.localized)
                //: return
                return
            }
            ...
            guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
                ...
                self.revenueMsg(showMsg: (String(app_formerMessage) + String(dataMaterialMessage)).localized)
                //: return
                return
            }
            ...
            if self.chatRoomID.count > 0 {
                ...
                guard self.chatRoomgiftSelectedMemberModel != nil else {
                    ...
                    self.revenueMsg(showMsg: (String(k_cutOthersMsg.prefix(6)) + " sele" + String(dataSpotScrambleMsg.prefix(4)) + "n obje" + String(user_numbDragContactId)).localized)
                    //: return
                    return
                }
                ...
                if self.chatRoomSendActionBlock != nil {
                    ...
                    guard let dataType = DoweryTermConvertible(rawValue: self.giftSelectedModel.lastHotIndexPath.section) else { return }
                    //: let dataArr = self.getGiftData(dataType: dataType)
                    let dataArr = self.eraseKind(dataType: dataType)
                    //: if index < dataArr.count {
                    if index < dataArr.count {
                        //: let giftModel: TalkingRoomGiftModel = dataArr[index] as! TalkingRoomGiftModel
                        let giftModel: MyGiftModel = dataArr[index] as! MyGiftModel
    ...
    private lazy var giftInputNumTF: UITextField = {
        ...
        tf.addTarget(self, action: #selector(pressErase(_:)), for: .editingChanged)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillBeHidden(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(yesterdayNarrowNotification(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWasShown(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(valid(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.text = String(bytes: showCoordinateName.reversed(), encoding: .utf8)!.localized
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(owner), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var seleteObjectBtn: UIButton = {
        ...
        btn.setTitle((String(showMakerToneStr.prefix(6)) + " obje" + String(user_flagStr.prefix(4))).localized, for: .normal)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        //: btn.layer.cornerRadius = 15
        btn.layer.cornerRadius = 15
        ...
        btn.addTarget(self, action: #selector(objectAngle), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var blindBoxExplainBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(zarf), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var giftEmptyView: UILabel = {
        ...
        lab.text = (String(main_failMessage.prefix(4)) + "ooks " + showModestMaxValue.replacingOccurrences(of: "by", with: "k") + " there\'s " + String(main_serverMessage)).localized
    ...
    private lazy var askforBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.originInstance(colors: [UIColor(hex: (data_helpFormat.replacingOccurrences(of: "screen", with: "F") + kSpendFormat.replacingOccurrences(of: "interrupt", with: "4")))!.cgColor, UIColor(hex: (noti_edgeStr.replacingOccurrences(of: "distinguish", with: "70")))!.cgColor], size: CGSize(width: 68, height: 30)), for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Semibold, fontSize: 15)
        btn.titleLabel?.font = UIFont.opPoint(type: .Semibold, fontSize: 15)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        ...
        btn.setTitle((String(app_advertisingHarvestText)).localized, for: .normal)
        //: btn.addTarget(self, action: #selector(askforBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(askforCutSnap), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension PerCentumReactiveCompatible {
    /// 隐藏视图
    //: @objc func dismissView() {
    @objc func advancedDoing() {
        ...
        UIView.animate(withDuration: 0.3) {
            ...
            self.contentView.frame = CGRect(x: 0, y: dataViewPath, width: dataShowDetailPopMessage, height: self.contentHeight)
            //: } completion: { _ in
        } completion: { _ in
    ...
    func globalChin() {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            ...
            self.contentView.frame = CGRect(x: 0, y: dataViewPath - self.contentHeight, width: dataShowDetailPopMessage, height: self.contentHeight)
            //: }, completion: nil)
        }, completion: nil)
    }
    ...
    @objc private func owner() {
        //: let index = self.giftSelectedModel.lastHotIndexPath.row
        let index = self.giftSelectedModel.lastHotIndexPath.row
        //: guard let dataType = GiftDataType(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        guard let dataType = DoweryTermConvertible(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        //: let dataArr = self.getGiftData(dataType: dataType)
        let dataArr = self.eraseKind(dataType: dataType)
    ...
    @objc func objectAngle() {
        //: meneView = DropDownMemberMenuView.init(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
        meneView = HappeningViewDelegate(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
    ...
    @objc func zarf() {
        //: dismissView()
        advancedDoing()
        //: LatPushManager.share.func__pushToWebVC(webViewType: .luckyBlindBox)
        LatPushManager.share.medianType(webViewType: .luckyBlindBox)
    }

    /// 索要礼物
    //: @objc func askforBtnClick() {
    @objc func askforCutSnap() {
        //: guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
        guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
            //: self.func__showStatusBarErrorMsg(showMsg: "Please select a gift".localized)
            self.revenueMsg(showMsg: (String(app_formerMessage) + String(dataMaterialMessage)).localized)
...
extension PerCentumReactiveCompatible {
    ...
    func decisionComplete(pkgItemsetId: String, num: Int) {
        //: guard currType == .Bags else { return }
        guard currType == .Bags else { return }
        //: DispatchQueue.main.async {
        DispatchQueue.main.async {
            //: var bagsDataArr = self.getGiftData(dataType: self.currType) as! [TalkingRoomGiftModel]
            var bagsDataArr = self.eraseKind(dataType: self.currType) as! [MyGiftModel]
            // 找到当前背包礼物索引，更新数量
            ...
            HimGiftManager.share.carryThroughMutualCollectionArr(dataType: self.currType, dataArr: bagsDataArr)
            ...
            self.gravity(force: true)
        }
    }
}

// MARK: - SinceViewDelegate

//: extension TalkingChatGiftView: DropDownMemberMenuViewDelegate {
extension PerCentumReactiveCompatible: SinceViewDelegate {
    //: func didClickSelectedRow(model: TalkingChatRoomMemberModel) {
    func intervalernationality(model: StatusStrokeModelType) {
        //: self.chatRoomgiftSelectedMemberModel = model
        self.chatRoomgiftSelectedMemberModel = model
        //: seleteObjectBtn.setTitle(" Select %@ > ".localizedArguments(model.nickname), for: .normal)
        seleteObjectBtn.setTitle((String(k_giftPath)).publicTransport(model.nickname), for: .normal)
    }

    /// 存储聊天室最近送礼人
    //: func saveRecentMembers() {
    func acceptResPremium() {
        ...
        if model.nickname == (String(dataQuantityervalStr) + String(constLandValue)).localized {
            //: return
            return
        }
        //: var ishave = false
        ...
        for tmodel in recentmenuArray {
            ...
            let temp = tmodel as! StatusStrokeModelType
    ...
    func yellow(title: String) {
        ...
        let str = (String(mainStartKey.prefix(4)) + " det" + String(notiAwakeContent.suffix(9)) + const_clingName.replacingOccurrences(of: "motivation", with: "r") + "ion >").localized
        //: let str2 = title + "\n" + str
        let str2 = title + "\n" + str
...
extension PerCentumReactiveCompatible: UICollectionViewDelegate, UICollectionViewDataSource {
    //: func getGiftData(dataType: GiftDataType) -> [Any] {
    func eraseKind(dataType: DoweryTermConvertible) -> [Any] {
        //: return TalkingChatGiftManager.share.getHotGiftDataSource(dataType: dataType)
        return HimGiftManager.share.pulchritude(dataType: dataType)
    }

    //: func giftSendItems() -> Array<Any> {
    func modelItems() -> [Any] {
        //: return TalkingChatGiftManager.share.getSendingItems()
        return HimGiftManager.share.people()
    }
    ...
    func disclike(needReload: Bool, mf_coin: String) {
        ...
        if dataArr.count > 0, index >= 0, index < dataArr.count {
            ...
            giftSelectedModel.isNoChangeGiftNumber = (hotModel.showType == PeopleSignedCount.myStery.rawValue)
        }
        ...
        hotGiftLayout.hotDataArr = eraseKind(dataType: .Hot)
        //: hotGiftLayout.vipDataArr = getGiftData(dataType: .Vip)
        hotGiftLayout.vipDataArr = eraseKind(dataType: .Vip)
        //: hotGiftLayout.bagsDataArr = getGiftData(dataType: .Bags)
        hotGiftLayout.bagsDataArr = eraseKind(dataType: .Bags)
    ...
    @objc fileprivate func pressErase(_ textField: UITextField) {
        ...
        if str.count == 2 && str.hasPrefix("0") {
            ...
            self.giftInputNumTF.text = (notiRoundTitle.replacingOccurrences(of: "re", with: "9"))
            //: } else {
        } else {
    ...
    @objc func valid(notification: NSNotification) {
        ...
        giftInputNumInputView.frame = CGRect(x: 0, y: dataViewPath - CGFloat(keyborHeight) - 44, width: dataShowDetailPopMessage, height: 44)
    }

    //: @objc func keyboardWillBeHidden(notification: NSNotification) {
    @objc func yesterdayNarrowNotification(notification _: NSNotification) {
    ...
    func porcupineProvision() {
        //: let sendingItems = giftSendItems()
        let sendingItems = modelItems()
        //: var titleArray = Array<String>()
        var titleArray = [String]()
        //: for i in 1..<sendingItems.count {
        for i in 1 ..< sendingItems.count {
            //: let text = String(numberOfGiftForIndex(index: i))
            let text = String(graduatedTableLayer(index: i))
//            let giftNumArrModel: HrArrModel = sendingItems[i] as! HrArrModel
//            text += "  " + (giftNumArrModel.tag ?? "")
            //: titleArray.append(text)
            titleArray.append(text)
        }
        //: titleArray.append("Custom".localized)
        titleArray.append((String(userNetworkStr)).localized)

        //: Config.MenuCellConfig.menuCellHeight = 40
        Config.CommentCap.menuCellHeight = 40

        //: let dropMenu = DropDownMenuView.pullDropDrownMenu(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
        let dropMenu = SpringAttributeThen.quoteTheme(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
    ...
    func pitchFragment() {
        ...
        let cell = self.hotGiftCollectionView.cellForItem(at: giftSelectedModel.lastHotIndexPath) as? AttributeRequestReactiveCompatible
        //: cell?.updateSelectedNumber(number: giftSelectedModel.hotGiftNum)
        cell?.makeweight(number: giftSelectedModel.hotGiftNum)
    }
    ...
    func collectionView(_: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        guard let dataType = DoweryTermConvertible(rawValue: section) else { return 0 }
        //: let count = getGiftData(dataType: dataType).count
        let count = eraseKind(dataType: dataType).count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let identifier = AttributeRequestReactiveCompatible.className()
        //: let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! TalkingPackageGiftCell
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! AttributeRequestReactiveCompatible
        // 获取数据
        //: guard let dataType = GiftDataType(rawValue: indexPath.section) else { return cell }
        guard let dataType = DoweryTermConvertible(rawValue: indexPath.section) else { return cell }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = eraseKind(dataType: dataType)
        // 刷新cell
        ...
        if indexPath.row < dataArr.count {
            ...
            let giftModel: MyGiftModel = dataArr[indexPath.row] as! MyGiftModel
            //: cell.refreshCellView(currenmodel: giftModel, giftType: dataType)
            cell.clip(currenmodel: giftModel, giftType: dataType)
            //: cell.setChecked(checked: giftSelectedModel.lastHotIndexPath == indexPath)
            cell.rid(checked: giftSelectedModel.lastHotIndexPath == indexPath)
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let dataType = DoweryTermConvertible(rawValue: indexPath.section) else { return }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = eraseKind(dataType: dataType)
        ...
        giftSelectedModel.isNoChangeGiftNumber = (giftModel.showType == PeopleSignedCount.myStery.rawValue)
        //: blindBoxExplainBtn.isHidden = !(giftModel.showType == ChatGiftType.myStery.rawValue)
        blindBoxExplainBtn.isHidden = !(giftModel.showType == PeopleSignedCount.myStery.rawValue)
        ...
        if giftSelectedModel.lastHotIndexPath == indexPath {
            ...
            if giftModel.showType == PeopleSignedCount.myStery.rawValue && style == .normal {
                //: didClickSelectedCellRow(index: 0, title: "")
                terracePermission(index: 0, title: "")
                //: return
                return
            }
            //: var sendIndex = indexOfSendItemForNum(num: giftSelectedModel.hotGiftNum)
            var sendIndex = customInCurrency(num: giftSelectedModel.hotGiftNum)
            //: sendIndex = safeObjectAtIndexWithSendItems(addIndex: sendIndex+1)
            sendIndex = castRow(addIndex: sendIndex + 1)
            //: didClickSelectedCellRow(index: sendIndex, title: "")
            terracePermission(index: sendIndex, title: "")
            //: } else {
        } else {
            //: giftSelectedModel.hotGiftName = giftModel.name
            giftSelectedModel.hotGiftName = giftModel.name
            ...
            if giftSelectedModel.lastHotCell != nil {
                ...
                let cell: AttributeRequestReactiveCompatible = giftSelectedModel.lastHotCell as! AttributeRequestReactiveCompatible
                //: cell.setChecked(checked: false)
                cell.rid(checked: false)
            }
            //: let currentCell: TalkingPackageGiftCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! TalkingPackageGiftCell
            let currentCell: AttributeRequestReactiveCompatible = self.hotGiftCollectionView.cellForItem(at: indexPath) as! AttributeRequestReactiveCompatible
            //: currentCell.setChecked(checked: true)
            currentCell.rid(checked: true)
        ...
        if scrollView == hotGiftCollectionView {
            ...
            if isShowRight {
                ...
                DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.3) {
                    ...
                    self.titleScrollView.user(0, animated: true)
                    //: DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                        //: let dataArr = self.getGiftData(dataType: self.currType)
                        let dataArr = self.eraseKind(dataType: self.currType)
    ...
    func gravity(force: Bool = false) {
        // 计算page
        //: var traillingOffsetX = hotGiftCollectionView.contentOffset.x + ScreenWidth
        var traillingOffsetX = hotGiftCollectionView.contentOffset.x + dataShowDetailPopMessage
        //: traillingOffsetX = traillingOffsetX < ScreenWidth ? ScreenWidth : traillingOffsetX
        traillingOffsetX = traillingOffsetX < dataShowDetailPopMessage ? dataShowDetailPopMessage : traillingOffsetX
        //: var page = Int(traillingOffsetX/ScreenWidth-1)
        var page = Int(traillingOffsetX / dataShowDetailPopMessage - 1)
        //: page = page < 0 ? 0:page
        page = page < 0 ? 0 : page
        //: let addition = Int(traillingOffsetX)%Int(ScreenWidth) > 0 ? 1:0
        let addition = Int(traillingOffsetX) % Int(dataShowDetailPopMessage) > 0 ? 1 : 0
        //: page += addition
        page += addition

        // 判断当前选中分区
        //: var giftType = GiftDataType.Hot
        var giftType = DoweryTermConvertible.Hot
        ...
        if force == true || currType != giftType {
            ...
            pageControl.numberOfPages = HimGiftManager.share.recoupTerms(perPageCount: 8, dataType: currType)
            // 切换title
            //: titleScrollView.currentIndex = currType.rawValue
            titleScrollView.currentIndex = currType.rawValue
            //: titleScrollView.adjustUIWhenBtnOnClickWithAnimate(true)
            titleScrollView.streetwiseAnimate(true)
            //: askforBtn.isHidden = !(currType == GiftDataType.Hot && self.style == .normal && SteppingMotorThen.share.loginUserMode.sex == Gender.female.rawValue)
            askforBtn.isHidden = !(currType == DoweryTermConvertible.Hot && self.style == .normal && SteppingMotorThen.share.loginUserMode.sex == WalkMilitaryOutputStreamable.female.rawValue)
            // 盲盒礼物说明 显示/隐藏
            ...
            if giftSelectedModel.lastShowType == PeopleSignedCount.myStery.rawValue && giftSelectedModel.lastHotIndexPath.section == currType.rawValue {
...
// MARK: - FluAlongsideViewDelegate

//: extension TalkingChatGiftView: DropDownMenuViewDelegate {
extension PerCentumReactiveCompatible: FluAlongsideViewDelegate {
    //: func didClickSelectedRow(index: Int, title: String) {
    func clickHeadText(index: Int, title: String) {
        //: didClickSelectedCellRow(index: index+1, title: title)
        terracePermission(index: index + 1, title: title)
    }

    //: func  didClickSelectedCellRow(index: Int, title: String) {
    func terracePermission(index: Int, title _: String) {
        //: let numberOfGift = numberOfGiftForIndex(index: index)
        let numberOfGift = graduatedTableLayer(index: index)
        //: if numberOfGift>0 {
        if numberOfGift > 0 {
            ...
            popView?.shorthand(view: giftInputNumInputView)
            //: popView?.showInView(view: self.window!)
            popView?.distanceView(view: self.window!)
    ...
    func graduatedTableLayer(index: Int) -> Int {
        //: let sendingItems = giftSendItems()
        let sendingItems = modelItems()
        ...
        if sendingItems.count > 0 && index < sendingItems.count {
            ...
            let giftNumArrModel: HrArrModel = sendingItems[index] as! HrArrModel
    ...
    func customInCurrency(num: Int) -> Int {
        //: var index = 0
        var index = 0
        //: for i in 0..<giftSendItems().count {
        for i in 0 ..< modelItems().count {
            //: let model: TalkingGiftNumArrModel = giftSendItems()[i] as! TalkingGiftNumArrModel
            let model: HrArrModel = modelItems()[i] as! HrArrModel
            //: if model.num == num {
            if model.num == num {
                //: break
                break
    ...
    func castRow(addIndex: Int) -> Int {
        //: if addIndex > giftSendItems().count-1 {
        if addIndex > modelItems().count - 1 {
            //: return 0
            return 0
        }
        //: return addIndex
...
extension PerCentumReactiveCompatible {
    ...
    private func queryStop() {
        //: self.backgroundColor = UIColor.clear
        self.backgroundColor = UIColor.clear
        //: let tagView = UIView.init(frame: CGRect(x: 0, y: 0, width: ScreenWidth, height: ScreenHeight-contentHeight))
        let tagView = UIView(frame: CGRect(x: 0, y: 0, width: dataShowDetailPopMessage, height: dataViewPath - contentHeight))
        //: tagView.backgroundColor = .clear
        tagView.backgroundColor = .clear
        //: self.addSubview(tagView)
        self.addSubview(tagView)
        //: tagView.addGestureRecognizer(UITapGestureRecognizer.init(target: self, action: #selector(dismissView)))
        tagView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(advancedDoing)))
        ...
        scrollContentView.snp.makeConstraints { make in
            ...
            make.height.equalTo(app_outputMessage)
            //: make.width.equalTo(ScreenWidth)
            make.width.equalTo(dataShowDetailPopMessage)
        }
        ...
        hotGiftCollectionView.snp.makeConstraints { make in
            ...
            make.width.equalTo(dataShowDetailPopMessage - 10)
        }
        ...
        bottomView.snp.makeConstraints { make in
            ...
            make.height.equalTo(const_beginMsg)
        }
    ...
    private func counterplay() {
        //: SteppingMotorThen.share.loginUserMode.rx
        SteppingMotorThen.share.loginUserMode.rx
            //: .observeWeakly(String.self, "mf_coin")
            .observeWeakly(String.self, (String(data_standardMessage.suffix(5)) + dataDepthContent.replacingOccurrences(of: "transaction", with: "i")))
            ...
            .subscribe(onNext: { [weak self] value in
                ...
                if value != nil {
                    ...
                    self.disclike(needReload: false, mf_coin: value!)
                }
                //: })
            })
            //: .disposed(by: disposeBag)
        ...
        HimGiftManager.share.rx
            //: .observeWeakly(Bool.self, "showBagsRed")
            .observeWeakly(Bool.self, (String(dataCellMsg) + String(main_femaleData)))
            //: .subscribe(onNext: { [weak self] (value) in
            .subscribe(onNext: { [weak self] value in
                //: guard let self = self else { return }
                guard let self = self else { return }
                ...
                HimGiftManager.share.publishReplace(type: self.style, isRefresh: true, completion: {
                    //: self.updateGiftInfo(needReload: true, mf_coin: SteppingMotorThen.share.loginUserMode.mf_coin)
                    self.disclike(needReload: true, mf_coin: SteppingMotorThen.share.loginUserMode.mf_coin)
                    //: })
                })
                //: })
            })
