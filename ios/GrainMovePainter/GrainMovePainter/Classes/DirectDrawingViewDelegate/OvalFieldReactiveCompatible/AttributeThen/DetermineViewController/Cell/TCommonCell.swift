...
@objcMembers public class PingOvalCellData: NSObject {
    //: public var reuseId: String?
    public var reuseId: String?
    
    //: public func heightOfWidth(_ width: CGFloat) -> CGFloat {
    public func sendBySum(_ width: CGFloat) -> CGFloat {
        //: return 44
        return 44
    }
}
...
@objcMembers public class ArrayWhiteReactiveCompatible: UITableViewCell {
    
    //: private(set) public var data: TCommonCellData?
    private(set) public var data: PingOvalCellData?
    ...
    @objc dynamic public func panWith(with data: PingOvalCellData) {
        //: self.data = data
        self.data = data
    }
} 