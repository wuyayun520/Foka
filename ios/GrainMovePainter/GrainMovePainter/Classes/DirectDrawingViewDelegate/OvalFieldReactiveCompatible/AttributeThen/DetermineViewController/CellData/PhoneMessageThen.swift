...
@objc public enum NaturalResourceRelatableTarget: UInt {
...
@objc public enum SubstanceNameConvertible: UInt {
...
// MARK: - PhoneMessageThen

/**
 * 【模块名称】PhoneMessageThen
 ...
 */
//: @objcMembers public class PhoneMessageThen: TCommonCellData {
@objcMembers public class PhoneMessageThen: PingOvalCellData {
    ...
    public var direction: SubstanceNameConvertible = .MsgDirectionIncoming
    ...
    public var translateStatus: NaturalResourceRelatableTarget = .MsgTranslate_init
    ...
    public var msgModel: TareModel = TareModel()
    ...
    public var cellLayout: ResourceCellLayout!
    ...
    public init(direction: SubstanceNameConvertible) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.allSquare()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = ResourceCellLayout(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = ResourceCellLayout(isIncomming: false)
    ...
    public override func sendBySum(_ width: CGFloat) -> CGFloat {
