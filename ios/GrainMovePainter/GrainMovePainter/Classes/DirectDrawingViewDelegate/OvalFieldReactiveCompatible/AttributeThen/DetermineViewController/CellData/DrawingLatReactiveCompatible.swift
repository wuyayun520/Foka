...
fileprivate let k_brandProblemName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
// __CLOSE_PRINT__
//
//  DrawingLatReactiveCompatible.swift
//  GrainMovePainter
//
...
//: @objcMembers public class DrawingLatReactiveCompatible: PhoneMessageThen {
@objcMembers public class DrawingLatReactiveCompatible: PhoneMessageThen {
    //: var contentFont = UIFont.pingfangRugularFont(fontSize: 13)
    var contentFont = UIFont.promptReload(fontSize: 13)
    //: var contentColor = UIColor.appValueDetailColor()
    var contentColor = UIColor.uniformColor()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_brandProblemName.reversed(), encoding: .utf8)!)
    }

    //: public override func contentSize() -> CGSize {
    override public func largeInner() -> CGSize {
        //: let textSize = CGSize(width: ScreenWidth/2, height: ScreenHeight)
        let textSize = CGSize(width: dataShowDetailPopMessage / 2, height: dataViewPath)
    ...
    override public func sendBySum(_: CGFloat) -> CGFloat {
        ...
        return self.largeInner().height + 10
    }
}
