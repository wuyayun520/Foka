...
@objcMembers public class ResourceCellLayout: NSObject {
    ...
    class func alongsideDedication() -> ResourceCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = ResourceCellLayout.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func electronicEquipment() -> ResourceCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = ResourceCellLayout.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func banWith() -> ResourceCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = ResourceCellLayout.init(isIncomming: false)
    ...
    class func nothings() -> ResourceCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = ResourceCellLayout.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func reasoned() -> ResourceCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = ResourceCellLayout.init(isIncomming: false)
        //: return layout
        return layout
