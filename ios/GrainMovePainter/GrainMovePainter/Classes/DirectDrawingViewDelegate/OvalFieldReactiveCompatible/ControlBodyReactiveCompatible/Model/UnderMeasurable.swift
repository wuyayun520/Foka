...
struct MisinformationIncludingDanmuHandyJSON: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var messageType = 0
...
struct RecaptureTransformable: HandyJSON {
    //: var uid = 0
    var uid = 0
    //: var nickname = ""
    var nickname = ""
