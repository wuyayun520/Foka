...
/*: "&sr=6" :*/
fileprivate let const_currentlyTitle:String = "within thin dit scan delivery&sr=6"
...
enum CookieWalkSubqueryConvertible: String, CaseIterable {
...
enum FairAndSquareMirrorPath: String {
...
class SolarBatteryManager: NSObject {
    //: class func getFullUrl(urlType: WebUrlType)-> String {
    class func alleged(urlType: FairAndSquareMirrorPath) -> String {
        //: var url = SteppingMotorThen.share.appConfigMode.urlH5Domain
        var url = SteppingMotorThen.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(SteppingMotorThen.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : SteppingMotorThen.share.appUserConfigMode.fullRechargePage)
            url.append(SteppingMotorThen.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : SteppingMotorThen.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(SteppingMotorThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : SteppingMotorThen.share.appUserConfigMode.halfRechargePage)
            url.append(SteppingMotorThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : SteppingMotorThen.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = SteppingMotorThen.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = SteppingMotorThen.share.appUserConfigMode.halfRechargePage.appending((String(const_currentlyTitle.suffix(5))))
            //: url.append(SteppingMotorThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(SteppingMotorThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
