...
/*: "detection" :*/
fileprivate let appAnalysisMessage:[Character] = ["d","e","t","e","c","t","i","o","n"]

/*: "aiff" :*/
fileprivate let constSuspendName:[Character] = ["a","i","f","f"]
...
class AgentMotorThen: NSObject {
    // singleton
    //: static let shared = RBDMuteSwitch()
    static let shared = AgentMotorThen()
    ...
    func liveCloseicial() {
        ...
        let soundFilePath = EpisodeThen.default.databaseAlways(name: (String(appAnalysisMessage)), type: (String(constSuspendName)))
        ...
        let soundCompletionCallback: AudioServicesSystemSoundCompletionProc = { soundID, _ in
            ...
            AgentMotorThen.shared.complete()
        }
