...
fileprivate let constRankMessage:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_gift_placeholder" :*/
fileprivate let kMotivationTitle:String = "icon_gcapacity generate open toward constraint"
fileprivate let constNowData:String = "each title flatift_p"
fileprivate let mainTurnExhibitUrl:[Character] = ["l","a","c","e","h","o","l","d","e","r"]

/*: "Gift" :*/
fileprivate let dataDecideTodayCalledTitle:String = "Giftconsumer keep"
...
class DetailReusableView: UICollectionViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constRankMessage.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var giftBgView: UIView = {
        ...
        bgView.backgroundColor = .detergentSaveer(245, 245, 245, 1)
    ...
    private lazy var giftImgView: UIImageView = {
        ...
        imgV.image = UIImage.hr(name: (String(kMotivationTitle.prefix(6)) + String(constNowData.suffix(5)) + String(mainTurnExhibitUrl)))
        //: return imgV
        return imgV
        //: }()
    }()
    ...
    private lazy var nameLab: UILabel = {
        ...
        lb.text = (String(dataDecideTodayCalledTitle.prefix(4))).localized
...
extension DetailReusableView {
    //: func configGiftItemCellWithData(giftModel: TalkingUserReceivedGiftModel, _ isNewProfile: Bool) {
    func displayWindow(giftModel: TakeTransformable, _ isNewProfile: Bool) {
        //: giftImgView.setUrlImage(urlStr: giftModel.img)
        giftImgView.underStack(urlStr: giftModel.img)
