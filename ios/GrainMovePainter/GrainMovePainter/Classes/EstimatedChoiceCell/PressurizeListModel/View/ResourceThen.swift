...
fileprivate let userObserveName:[UInt8] = [0xcc,0xd1,0xcc,0xd7,0x8b,0xc6,0xd2,0xc7,0xc8,0xd5,0x9d,0x8c,0x83,0xcb,0xc4,0xd6,0x83,0xd1,0xd2,0xd7,0x83,0xc5,0xc8,0xc8,0xd1,0x83,0xcc,0xd0,0xd3,0xcf,0xc8,0xd0,0xc8,0xd1,0xd7,0xc8,0xc7]

fileprivate func denyExpected(contribution num: UInt8) -> UInt8 {
...
/*: "btn_me_edit" :*/
fileprivate let showPriceMineData:[Character] = ["b","t","n","_","m","e","_","e","d","i","t"]
...
class ResourceThen: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userObserveName.map{denyExpected(contribution: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.hr(name: (String(showPriceMineData))))
...
extension ResourceThen {
    ...
    func nestleLast(titile: String, row: Int, isLast: Bool) {
    ...
    func priceParent(detail: String) {
    ...
    func stack() {
        ...
        titleBLB.font = UIFont.opPoint(type: .Medium, fontSize: 15)
        //: detailLB.font = UIFont.pingfangFont(type: .Medium, fontSize: 15)
        detailLB.font = UIFont.opPoint(type: .Medium, fontSize: 15)
        //: editImag.isHidden = false
        editImag.isHidden = false
