...
Pod::Spec.new do |s|
  s.name         = "EnableDense"
  s.version      = "1.0.0"
  s.summary      = "iOS EnableDense Module."
  s.author       = { "EnableDense" => "EnableDense.me" }
  s.homepage     = "EnableDense"
  s.source       = { :git => "http://EnableDense.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'EnableDense/Classes/**/*'
  s.resources = "EnableDense/Resources/*.bundle"
  s.vendored_libraries = 'EnableDense/Classes/**/*.a'
