...
/*!消息体数据*/
//: @class AbTalkingChatMsgInfoModel, AbTalkingChatMsgUserModel, AbTalkingChatMsgToUserModel, AbTalkingChatMsgGiftModel, AbTalkingChatMsgTipsModel, ComprehendReactiveCompatible, AbTalkingChatMsgIntimatePhotoModel, AbTalkingChatMsgVideoModel, AbTalkingChatMsgCustomSendModel, AbTalkingChatMsgQuoteModel, AbTalkingChatMsgQuoteDataModel, WantGiftModel;
@class DetailedModel, Model, ChallengeModel, ZzModel, GuidanceModel, ComprehendReactiveCompatible, StumbleModel, SlideHypothesisModel, RocketModel, MedalFiniteModel, ChemicalElementModel, EnthusiasmPillowModel;

//: @interface AbTalkingChatMsgBaseModel : JSONModel
@interface TareModel : JSONModel

//: @property (nonatomic, strong)AbTalkingChatMsgInfoModel *msgInfo;
@property (nonatomic, strong)DetailedModel *msgInfo;

//: @property (nonatomic, strong)AbTalkingChatMsgUserModel *user;
@property (nonatomic, strong)Model *user;

//: @property (nonatomic, strong)AbTalkingChatMsgToUserModel *toUser;
@property (nonatomic, strong)ChallengeModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)ZzModel *gift;

//: @property (nonatomic, strong)AbTalkingChatMsgTipsModel *tips;
@property (nonatomic, strong)GuidanceModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)MedalFiniteModel *quoteMsgInfo;

//: @property (nonatomic, strong)ComprehendReactiveCompatible *userInfoModel;
@property (nonatomic, strong)ComprehendReactiveCompatible *userInfoModel;
...
@interface DetailedModel : JSONModel
...
@property (nonatomic, strong) StumbleModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) SlideHypothesisModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) RocketModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) EnthusiasmPillowModel *wantGift; /// 想要礼物
...
@interface StumbleModel : JSONModel
...
@interface SlideHypothesisModel: JSONModel
...
@interface ChallengeModel : JSONModel
...
@interface GuidanceModel : JSONModel
...
@interface EnthusiasmPillowModel : JSONModel
...
@interface MedalFiniteModel : JSONModel
...
@property (nonatomic, strong) ChemicalElementModel *renderData;
...
@interface ChemicalElementModel : JSONModel
