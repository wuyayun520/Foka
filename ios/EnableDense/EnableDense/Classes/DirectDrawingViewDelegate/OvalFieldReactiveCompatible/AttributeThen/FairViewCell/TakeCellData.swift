...
/*: ".png" :*/
fileprivate let userSearchName:[Character] = [".","p","n","g"]
...
//: @objcMembers public class TakeCellData: TalkingChatMsgBaseCellData {
@objcMembers public class TakeCellData: MpCapCellData {
    ...
    override public var msgModel: TareModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.lateFailure(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func per(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(noti_cornerKey)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + SteppingMotorThen.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + SteppingMotorThen.share.loginUserMode.userID + (String(userSearchName))
        ...
        let imageData = UIImage.always(image, stillOwnerAll: 2 * 1024)
