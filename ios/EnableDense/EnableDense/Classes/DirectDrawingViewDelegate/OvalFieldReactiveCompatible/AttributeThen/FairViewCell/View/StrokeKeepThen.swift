...
fileprivate let app_washMessage:[UInt8] = [0x8,0xf,0x8,0x15,0x49,0x2,0xe,0x5,0x4,0x13,0x5b,0x48,0x41,0x9,0x0,0x12,0x41,0xf,0xe,0x15,0x41,0x3,0x4,0x4,0xf,0x41,0x8,0xc,0x11,0xd,0x4,0xc,0x4,0xf,0x15,0x4,0x5]

private func styleFloat(op num: UInt8) -> UInt8 {
    return num ^ 97
}
...
class StrokeKeepThen: UIView {
    //: class func create(_ frame: CGRect) -> UIView {
    class func doingModify(_ frame: CGRect) -> UIView {
        //: return MAScreenShieldView(frame: frame)
        return StrokeKeepThen(frame: frame)
    }
    ...
    override init(frame: CGRect) {
        ...
        super.init(frame: frame)
        //: addSafeZoneView()
        unhazardousPerspectiveButtonSpot()
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_washMessage.map{styleFloat(op: $0)}, encoding: .utf8)!)
    }
...
extension StrokeKeepThen {
    //: func addSafeZoneView() {
    func unhazardousPerspectiveButtonSpot() {
