...
fileprivate let main_weeText:[UInt8] = [0xa5,0xaa,0xa5,0xb0,0x64,0x9f,0xab,0xa0,0xa1,0xae,0x76,0x65,0x5c,0xa4,0x9d,0xaf,0x5c,0xaa,0xab,0xb0,0x5c,0x9e,0xa1,0xa1,0xaa,0x5c,0xa5,0xa9,0xac,0xa8,0xa1,0xa9,0xa1,0xaa,0xb0,0xa1,0xa0]

fileprivate func moveContain(corner num: UInt8) -> UInt8 {
...
class PingLieItemLabel: UIView {
    //: private var giftSendItem = [TalkingGiftNumArrModel()]
    private var giftSendItem = [HrArrModel()]
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_weeText.map{moveContain(corner: $0)}, encoding: .utf8)!)
    }
    ...
    func shareSolar(attributedText: NSAttributedString) {
        ...
        shadow.shadowColor = UIColor.tillAdvancedColor()
    ...
    func pillowLengthFrame(frame: CGRect) {
        //: self.frame = frame
        self.frame = frame
    ...
    private lazy var gradientLayer: CAGradientLayer = {
        ...
        lay.colors = [UIColor.detergentSaveer(255, 232, 72, 1).cgColor, // 浅黄
                      //: UIColor.RGBA(253, 170, 52, 1).cgColor
                      UIColor.detergentSaveer(253, 170, 52, 1).cgColor, // 深黄
        ]
...
extension PingLieItemLabel {
    // 添加视图
    //: private func setupSubviews() {
    private func popularTop() {
