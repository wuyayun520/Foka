...
fileprivate let constMapKey:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_livetc_warn" :*/
fileprivate let app_minuteUrl:String = "tingcon"
fileprivate let dataPermissionName:String = "tc_wremark big explain color"
fileprivate let mainMomentCombinedStr:String = "arphoto"
...
class LieView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constMapKey.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.hr(name: (app_minuteUrl.replacingOccurrences(of: "ting", with: "i") + "_live" + String(dataPermissionName.prefix(4)) + mainMomentCombinedStr.replacingOccurrences(of: "photo", with: "n")))
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.textAlignment = .center
        //: lab.text = SteppingMotorThen.share.appUserConfigMode.blockCameraPopupContent
        lab.text = SteppingMotorThen.share.appUserConfigMode.blockCameraPopupContent
        //: lab.numberOfLines = 0
        lab.numberOfLines = 0
        //: return lab
