...
fileprivate let notiMentallyAlterText:[UInt8] = [0xa9,0xae,0xa9,0xb4,0x68,0xa3,0xaf,0xa4,0xa5,0xb2,0x7a,0x69,0x60,0xa8,0xa1,0xb3,0x60,0xae,0xaf,0xb4,0x60,0xa2,0xa5,0xa5,0xae,0x60,0xa9,0xad,0xb0,0xac,0xa5,0xad,0xa5,0xae,0xb4,0xa5,0xa4]

fileprivate func electronicVerse(mind num: UInt8) -> UInt8 {
...
/*: "icon_mini_voice_end" :*/
fileprivate let kPhoneName:String = "icon_advertising unable"
fileprivate let mainEffectData:String = "oice_ekeep examine"
fileprivate let notiCoordinatorId:[Character] = ["n","d"]

/*: "#F95151" :*/
fileprivate let k_cosMessage:String = "via"
fileprivate let main_gestureUrl:String = "F9netnet"

/*: "End of call" :*/
fileprivate let app_enoughFormat:String = "End ogap visitor log off"

/*: "img_home_shadow_icon" :*/
fileprivate let data_dragContent:[Character] = ["i","m","g","_","h","o","m","e"]
fileprivate let appBrightKey:String = "_"
fileprivate let kHelloTitle:String = "SHAD"
...
class VideoMiniView: SpecialFluView {
    // 小窗口通话状态
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiMentallyAlterText.map{electronicVerse(mind: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var statusIcon: UIImageView = {
        ...
        img.image = UIImage.hr(name: (String(kPhoneName.prefix(5)) + "mini_v" + String(mainEffectData.prefix(6)) + String(notiCoordinatorId)))
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (k_cosMessage.replacingOccurrences(of: "via", with: "#") + main_gestureUrl.replacingOccurrences(of: "net", with: "51")))
        //: lab.font = .pingfangFont(type: .Medium, fontSize: 10)
        lab.font = .opPoint(type: .Medium, fontSize: 10)
        //: lab.textAlignment = .center
        lab.textAlignment = .center
        //: lab.text = "End of call".localized
        lab.text = (String(app_enoughFormat.prefix(5)) + "f call").localized
    ...
    private lazy var shadowImg: UIImageView = {
        ...
        img.image = UIImage.hr(name: (String(data_dragContent) + appBrightKey.capitalized + kHelloTitle.lowercased() + "ow_icon"))
