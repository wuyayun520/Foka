...
fileprivate let noti_mightStr:[UInt8] = [0x87,0x80,0x87,0x9a,0xc6,0x8d,0x81,0x8a,0x8b,0x9c,0xd4,0xc7,0xce,0x86,0x8f,0x9d,0xce,0x80,0x81,0x9a,0xce,0x8c,0x8b,0x8b,0x80,0xce,0x87,0x83,0x9e,0x82,0x8b,0x83,0x8b,0x80,0x9a,0x8b,0x8a]

private func yesStreet(loose num: UInt8) -> UInt8 {
    return num ^ 238
}

/*: "#F5F5F5" :*/
fileprivate let user_communicateUrl:String = "map in#F5F5F5"

/*: "level_ :*/
fileprivate let notiRouteContent:[Character] = ["l","e","v","e","l","_"]
...
class CellView: UITableViewCell {
    ...
    var currenModel = ProcessingModelType()
    //: var index = 0
    var index = 0
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_mightStr.map{yesStreet(loose: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var indexLB: UILabel = {
        ...
        label.font = .opPoint(type: .Regular, fontSize: 20)
    ...
    lazy var lineView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(user_communicateUrl.suffix(7))))
        //: return view
        return view
        //: }()
    }()
...
extension CellView {
    ...
    func attractorIndex(model: ProcessingModelType, index: Int) {
        //: currenModel = model
        currenModel = model
        //: self.index = index
        self.index = index
        ...
        IconImg.underStack(urlStr: model.headPic)
        //: nameLabel.text = model.nickname
        nameLabel.text = model.nickname
        //: levelIcon.image = UIImage.BundleImageNamed(name: "level_\(model.level )")
        levelIcon.image = UIImage.hr(name: (String(notiRouteContent)) + "\(model.level)")
    }
}
