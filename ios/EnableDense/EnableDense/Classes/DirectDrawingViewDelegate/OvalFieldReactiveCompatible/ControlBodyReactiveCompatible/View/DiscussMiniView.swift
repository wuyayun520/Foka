...
fileprivate let main_quickFormat:[UInt8] = [0x8a,0x8f,0x8a,0x95,0x49,0x84,0x90,0x85,0x86,0x93,0x5b,0x4a,0x41,0x89,0x82,0x94,0x41,0x8f,0x90,0x95,0x41,0x83,0x86,0x86,0x8f,0x41,0x8a,0x8e,0x91,0x8d,0x86,0x8e,0x86,0x8f,0x95,0x86,0x85]

fileprivate func representativeBy(po num: UInt8) -> UInt8 {
...
class DiscussMiniView: SpecialFluView {
    // 播放结束Block
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_quickFormat.map{representativeBy(po: $0)}, encoding: .utf8)!)
    }
...
extension DiscussMiniView {
    /// 开始播放直播
    //: func setupPlayer(liveUrl: String) {
    func belowFlagMini(liveUrl: String) {
...
extension DiscussMiniView: TXLivePlayListener {
