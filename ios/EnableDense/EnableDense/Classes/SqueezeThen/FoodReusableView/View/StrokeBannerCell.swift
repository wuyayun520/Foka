...
fileprivate let data_dropId:[UInt8] = [0x4a,0x4f,0x4a,0x55,0x9,0x44,0x50,0x45,0x46,0x53,0x1b,0xa,0x1,0x49,0x42,0x54,0x1,0x4f,0x50,0x55,0x1,0x43,0x46,0x46,0x4f,0x1,0x4a,0x4e,0x51,0x4d,0x46,0x4e,0x46,0x4f,0x55,0x46,0x45]

fileprivate func givingListen(upon num: UInt8) -> UInt8 {
...
/*: "JXBannerCellID" :*/
fileprivate let main_centerPath:[Character] = ["J","X","B","a","n","n","e","r","C","e","l"]
fileprivate let const_someoneVoiceFormat:String = "lIDoriginal verse clock array share"
...
class StrokeBannerCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: data_dropId.map{givingListen(upon: $0)}, encoding: .utf8)!)
    }
...
extension StrokeBannerCell: JXBannerDataSource, JXBannerDelegate {
    //: func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        //: return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: "JXBannerCellID")
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (String(main_centerPath) + String(const_someoneVoiceFormat.prefix(3))))
    }
...
extension StrokeBannerCell {
    /// 更新数据
    //: func setViewData(bannerData: [SocialAdBannerModel]) {
    func dataSub(bannerData: [MpTransformable]) {
