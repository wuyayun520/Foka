...
fileprivate let kPlainData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "img_match_shadow" :*/
fileprivate let userEquipmentMessage:String = "img_maspend violation relieve"
fileprivate let main_attitudeValue:String = "shadosample"

/*: "icon_match_topshowdown" :*/
fileprivate let const_portData:String = "feedback appealicon_"
fileprivate let show_ruleDetailedValue:String = "h_toreplacement class silver pillow become"
fileprivate let userSuiteFormat:String = "WDOWN"

/*: "Matching..." :*/
fileprivate let app_minimizeMsg:String = "Matchibrain walk range"
fileprivate let showRefrigeratorMessage:[Character] = ["."]

/*: "get json error" :*/
fileprivate let userPullKey:String = "compute prepare hisget j"
fileprivate let kUtilityUrl:String = "worldworldoworld"

/*: "img_home_shadow" :*/
fileprivate let data_messageStr:[Character] = ["i","m","g","_","h","o"]
fileprivate let notiBearValidName:[Character] = ["m","e","_","s","h","a","d","o","w"]

/*: "icon_home_girl" :*/
fileprivate let constTogetherBottomSubjectPath:String = "icon_hbubble opposition rate"
fileprivate let kAgendaMsg:[Character] = ["g","i","r","l"]
...
typealias TouchCallBlock = (_ model: DrawingHandyJSON) -> Void

//: class TalkingClubCardItemCell: TalkingClubCardViewCell {
class CompartmentItemCell: MixViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kPlainData.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var gradientShadowImageView: UIImageView = {
        ...
        imageView.image = UIImage.hr(name: (String(userEquipmentMessage.prefix(6)) + "tch_" + main_attitudeValue.replacingOccurrences(of: "sample", with: "w")))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var topShowdImageView: UIImageView = {
        ...
        imageView.image = UIImage.hr(name: (String(const_portData.suffix(5)) + "matc" + String(show_ruleDetailedValue.prefix(4)) + "psho" + userSuiteFormat.lowercased()))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var sexBtn: UIButton = {
        ...
        btn.titleLabel?.font = .opPoint(type: .Medium, fontSize: 13)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var matchTipsLabel: UILabel = {
        ...
        label.text = (String(app_minimizeMsg.prefix(6)) + "ng.." + String(showRefrigeratorMessage)).localized
        //: label.isHidden = true
        label.isHidden = true
        //: return label
        return label
    ...
    private lazy var callBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(startMini), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    lazy var callPlayer: SVGAPlayer = {
        ...
        let url = EpisodeThen.default.noGoArea(type: .Match_userCall)
        //: do {
        do {
            ...
            printLog(message: (String(userPullKey.suffix(5)) + "son e" + kUtilityUrl.replacingOccurrences(of: "world", with: "r")))
        }
        //: return player
        return player
        //: }()
...
extension CompartmentItemCell {
    ...
    func belowValue(model: DrawingHandyJSON) {
        //: self.model = model
        self.model = model
        ...
        if model.cover.count > 0 {
            ...
            userImageView.salute(urlStr: model.cover, placeImg: UIImage.hr(name: (String(data_messageStr) + String(notiBearValidName))))
            ...
            userImageView.salute(urlStr: model.headPic, placeImg: UIImage.hr(name: (String(data_messageStr) + String(notiBearValidName))))
            //: } else {
        } else {
            //: userImageView.image = UIImage.BundleImageNamed(name: "img_home_shadow")
            userImageView.image = UIImage.hr(name: (String(data_messageStr) + String(notiBearValidName)))
        }
        //: userIconImg.setUrlImage(urlStr: model.headPic, placeImg: nil)
        userIconImg.underStack(urlStr: model.headPic, placeImg: nil)
        //: nameLabel.text = model.nickname
        nameLabel.text = model.nickname
        //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: "icon_home_girl"), for: .normal)
        sexBtn.setBackgroundImage(UIImage.hr(name: (String(constTogetherBottomSubjectPath.prefix(6)) + "ome_" + String(kAgendaMsg))), for: .normal)
