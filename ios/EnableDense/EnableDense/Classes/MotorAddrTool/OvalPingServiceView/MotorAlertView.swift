...
fileprivate let noti_ficeValue:String = "globalt"
fileprivate let showAgentBindId:[Character] = ["n","_","m","e","_","b","a","c","k","_","c","o","n","t","i","n","u","e"]

/*: "init(coder:) has not been implemented" :*/
fileprivate let noti_formId:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class MotorAlertView: UIView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(completeTag), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(windowOf), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: WhiteAlertConfig)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (noti_ficeValue.replacingOccurrences(of: "global", with: "b") + String(showAgentBindId))
        }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_formId.reversed(), encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func doBuild(title: String, isTouch: Bool) {
