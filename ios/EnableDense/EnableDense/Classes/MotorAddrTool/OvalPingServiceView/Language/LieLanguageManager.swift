...
@objcMembers open class LieLanguageManager: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = LieLanguageManager()
    //: private(set) var currLanguage: String = DetermineJoinReactiveCompatible.getSystemLangCode()
    private(set) var currLanguage: String = DetermineJoinReactiveCompatible.exCatch()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func fallBack(_ language: String) {
...
public extension NSString {
    ...
    @objc func discountLocalized() -> String {
...
extension String {
    ...
    public func publicTransport(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let languageFolder = EpisodeThen.default.languagePath
