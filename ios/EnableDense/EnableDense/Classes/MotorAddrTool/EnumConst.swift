...
enum ComparisonOnsetTarget: Int {
    //: case Social  = 0
    case Social = 0 // 交友
    //: case Moment  = 1
    case Moment = 1 // 动态
...
enum BulletTextConvertible: String {
    //: case AppleLogin
...
enum SpringHangBinaryCount: Int {
    //: case Normal         = 0
    case Normal = 0
    //: case NetError       = -10000
...
/// 性别
//: enum Gender: String {
enum WalkMilitaryOutputStreamable: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum PositiveSubscriptType: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum LieColumnConvertible: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum IsomerizationQuickLookable: Int {
    //: case isOnGoing = 0
...
@objc enum EchoTermConvertible: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum BassSwitchsetTarget: Int {
    //: case Unavailable = 0
...
enum CompartmentCellType: CaseIterable {
