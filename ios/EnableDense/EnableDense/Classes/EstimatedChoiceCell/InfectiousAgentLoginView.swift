...
fileprivate let mainWipeUserId:[UInt8] = [0x28,0x2d,0x28,0x33,0xe7,0x22,0x2e,0x23,0x24,0x31,0xf9,0xe8,0xdf,0x27,0x20,0x32,0xdf,0x2d,0x2e,0x33,0xdf,0x21,0x24,0x24,0x2d,0xdf,0x28,0x2c,0x2f,0x2b,0x24,0x2c,0x24,0x2d,0x33,0x24,0x23]

fileprivate func fingerSweep(scale num: UInt8) -> UInt8 {
...
/*: "Enter phone number" :*/
fileprivate let appAllPath:[Character] = ["E","n","t","e","r"," ","p","h","o","n","e"," ","n","u","m","b","e","r"]

/*: "Enter Email Address" :*/
fileprivate let kCommentMessage:[Character] = ["E","n","t","e","r"," ","E","m"]
fileprivate let mainPathContent:[Character] = ["a","i","l"," "]
fileprivate let show_refRecentContent:[Character] = ["A","d","d","r","e","s","s"]

/*: "F4F4F4" :*/
fileprivate let showCycleData:String = "Fbehindbehind4"

/*: "America(+1)" :*/
fileprivate let const_allyText:String = "Ameriprint brow customer cigarette guide"

/*: "area_code_down_icon" :*/
fileprivate let noti_fileData:[Character] = ["a","r","e","a","_","c","o","d","e","_","d","o","w","n","_","i","c","o","n"]

/*: "BBBBBB" :*/
fileprivate let user_unitStr:[Character] = ["B","B","B","B","B"]
fileprivate let app_correctMessage:[Character] = ["B"]

/*: "btn_field_delete_icon" :*/
fileprivate let const_towardName:[Character] = ["b","t","n","_","f","i","e","l","d","_","d","e","l","e","t","e","_","i","c"]
fileprivate let user_cornerNearDealFormat:String = "carriern"

/*: "Password" :*/
fileprivate let appMeasurementFormat:String = "Passworaverage then"
fileprivate let data_tickStr:String = "govern"

/*: "CCCCCC" :*/
fileprivate let kDismissTheId:String = "childchildchildchildchildchild"

/*: "F5F5F5" :*/
fileprivate let dataDensePath:[Character] = ["F","5","F","5","F","5"]

/*: "Next" :*/
fileprivate let dataAlterValue:[Character] = ["N","e","x","t"]

/*: "Login by password" :*/
fileprivate let appWouldId:String = "area reminderLogin"
fileprivate let noti_ionTitle:String = "wforeignrd"

/*: "Login by OTP" :*/
fileprivate let showOutputValue:String = "comment rid extend injury alwaysLogi"
fileprivate let show_approvalData:String = "n by OTPrestaurant rid refer player rent"

/*: "#8C7AFF" :*/
fileprivate let showRentStr:String = "storage satisfy he or#8C7AFF"

/*: "Login" :*/
fileprivate let dataPlaceMessage:[Character] = ["L","o","g","i","n"]

/*: "Send verification" :*/
fileprivate let constProvokeOfCalendarPath:String = "Send outer woman"
fileprivate let noti_lagName:String = "elementation"
...
// __CLOSE_PRINT__
//
//  InfectiousAgentLoginView.swift
//  AbroadTalking
//
...
class InfectiousAgentLoginView: UIView, UITextFieldDelegate {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mainWipeUserId.map{fingerSweep(scale: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.text = self.loginType == .LoginPhone ? (String(appAllPath)).localized : (String(kCommentMessage) + String(mainPathContent) + String(show_refRecentContent)).localized
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaCodeControl: UIControl = {
        ...
        control.backgroundColor = UIColor(hex: (showCycleData.replacingOccurrences(of: "behind", with: "4F")))
    ...
    lazy var areaCodeLabel: UILabel = {
        ...
        label.text = (String(const_allyText.prefix(5)) + "ca(+1)")
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaDownImgView: UIImageView = {
        ...
        imageView.image = UIImage.hr(name: (String(noti_fileData)))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var phoneInputView: UITextField = {
        ...
        textField.backgroundColor = UIColor(hex: (showCycleData.replacingOccurrences(of: "behind", with: "4F")))
        ...
        textField.attributedPlaceholder = NSAttributedString(string: "", attributes: [NSAttributedString.Key.font: UIFont.opPoint(type: .Regular, fontSize: 17), NSAttributedString.Key.foregroundColor: UIColor(hex: (String(user_unitStr) + String(app_correctMessage)))!])
    ...
    private lazy var phoneDeleteBtn: UIButton = {
        ...
        btn.setImage(UIImage.hr(name: (String(const_towardName) + user_cornerNearDealFormat.replacingOccurrences(of: "carrier", with: "o"))), for: .normal)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var pwdTitleLab: UILabel = {
        ...
        lab.text = (String(appMeasurementFormat.prefix(7)) + data_tickStr.replacingOccurrences(of: "govern", with: "d")).localized
    ...
    lazy var otherLabel: UILabel = {
        ...
        label.textColor = UIColor(hex: (kDismissTheId.replacingOccurrences(of: "child", with: "C")))
    ...
    lazy var otherLeftLine: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(dataDensePath)))
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var commitButton: UIButton = {
        ...
        btn.setTitle((String(dataAlterValue)).localized, for: .normal)
    ...
    private lazy var loginStyleBtn: UIButton = {
        ...
        btn.setTitleColor(UIColor.nameure(), for: .selected)
        //: btn.setTitle("Login by password".localized, for: .normal)
        btn.setTitle((String(appWouldId.suffix(5)) + " by pass" + noti_ionTitle.replacingOccurrences(of: "foreign", with: "o")).localized, for: .normal)
        //: btn.setTitle("Login by OTP".localized, for: .selected)
        btn.setTitle((String(showOutputValue.suffix(4)) + String(show_approvalData.prefix(8))).localized, for: .selected)
        //: btn.addTarget(self, action: #selector(loginStyleButtonClick(sender:)), for: .touchUpInside)
        btn.addTarget(self, action: #selector(get(sender:)), for: .touchUpInside)
        //: btn.layer.cornerRadius = 25
        btn.layer.cornerRadius = 25
        //: btn.layer.borderWidth = 2
        btn.layer.borderWidth = 2
        //: btn.layer.borderColor = UIColor(hex: "#8C7AFF")?.withAlphaComponent(0.6).cgColor
        btn.layer.borderColor = UIColor(hex: (String(showRentStr.suffix(7))))?.withAlphaComponent(0.6).cgColor
        //: return btn
        return btn
        //: }()
    }()
...
extension InfectiousAgentLoginView {
    /// 更新提交按钮状态
    ...
    @objc private func get(sender: UIButton) {
        ...
        if sender.isSelected == true { // pwd
            ...
            commitButton.setTitle((String(dataPlaceMessage)).localized, for: .normal)
            //: } else {
        } else { // OTP
            //: commitButton.setTitle("Next".localized, for: .normal)
            commitButton.setTitle((String(dataAlterValue)).localized, for: .normal)
        }
    ...
    func tool() {
        ...
        commitButton.setTitle((String(constProvokeOfCalendarPath.prefix(5)) + "verif" + noti_lagName.replacingOccurrences(of: "element", with: "ic")).localized, for: .normal)
    }
}
