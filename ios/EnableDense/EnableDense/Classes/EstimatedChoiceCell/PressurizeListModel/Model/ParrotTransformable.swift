...
struct ParrotTransformable: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: StrokeMomentModel?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [ProgramTransformable]? // 相册
    ...
    var aiExtraInfo = GenerationMeasurable() // AI模型
    //: var vipSkinId = 0
...
struct StrokeMomentModel: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
    //: var list: Array<TalkingUserInfoMomentItemModel>?
    var list: [HemTransformable]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct HemTransformable: HandyJSON {
...
struct ProgramTransformable: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func characterTo(compareTo: ProgramTransformable) -> Bool {
        //: return
        return
...
struct GenerationMeasurable: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
