...
fileprivate let user_scriptManagerDignityMessage:[UInt8] = [0x83,0x84,0x83,0x9e,0xc2,0x89,0x85,0x8e,0x8f,0x98,0xd0,0xc3,0xca,0x82,0x8b,0x99,0xca,0x84,0x85,0x9e,0xca,0x88,0x8f,0x8f,0x84,0xca,0x83,0x87,0x9a,0x86,0x8f,0x87,0x8f,0x84,0x9e,0x8f,0x8e]

/*: "icon_shouye_biaoshi_default" :*/
fileprivate let noti_middleCurMsg:[Character] = ["i","c","o","n","_","s","h","o","u","y","e","_","b","i","a","o","s","h","i","_","d","e","f","a","u","l","t"]
...
class DialogView: UICollectionViewCell {
    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: user_scriptManagerDignityMessage.map{$0^234}, encoding: .utf8)!)
    }
    ...
    private lazy var authImgV: UIImageView = {
        ...
        v.image = UIImage(named: (String(noti_middleCurMsg)))
    ...
    private lazy var nameLab: UILabel = {
        ...
        lab.font = .opPoint(type: .Regular, fontSize: 15)
...
extension DialogView {
    ...
    func quantityCell(_ model: SpecialFoodHandyJSON?) {
        //: guard let model = model else { return }
        guard let model = model else { return }
        //: headImgView.kf.setImage(with: URL(string: model.headPic), placeholder: UIImage.placeHolderImage(sex: model.sex))
        headImgView.kf.setImage(with: URL(string: model.headPic), placeholder: UIImage.contentTip(sex: model.sex))
