...
extension SignUpTool {
    ...
    func collectionCamera(_ frontCamera: Bool) {
        ...
        self.assign(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func silver(_ openCamera: Bool) {
        ...
        self.smallTapSlow(isOpen: openCamera)
    }
    ...
    func theView() {
        ...
        DispatchQueue.main.async {
            ...
            self.someoneWindow(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension SignUpTool {
    ...
    private func assign(front: Bool) {
    ...
    private func smallTapSlow(isOpen: Bool) {
        //: guard SenseTime_Use == true else {
        guard const_environmentMsg == true else {
            //: if isOpen {
            if isOpen {
...
extension SignUpTool {
    ...
    func slideIcon() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(reEnterProduct(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(holdingNotif(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(callback(notif:)),
    ...
    @objc private func reEnterProduct(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func holdingNotif(notif: Notification) {
    ...
    @objc func callback(notif: Notification) {
...
extension SignUpTool {
    ...
    func succeedPreview() {
        ...
        if self.infoModel?.videoStage == .Waiting {
            ...
            someoneWindow(smallWindow: false)
        ...
        //: } else if self.infoModel?.videoStage == .Calling {
            ...
            //: } else {
                ...
                someoneWindow(smallWindow: true)
            }
        }
    ...
    func someoneWindow(smallWindow: Bool) {
        //: guard SenseTime_Use == true else {
        guard const_environmentMsg == true else {
