...
Pod::Spec.new do |s|
  s.name         = "ChartFindSilentOpen"
  s.version      = "1.0.0"
  s.summary      = "iOS ChartFindSilentOpen Module."
  s.author       = { "ChartFindSilentOpen" => "ChartFindSilentOpen.me" }
  s.homepage     = "ChartFindSilentOpen"
  s.source       = { :git => "http://ChartFindSilentOpen.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'ChartFindSilentOpen/Classes/**/*'
  s.resources = "ChartFindSilentOpen/Resources/*.bundle"
  s.vendored_libraries = 'ChartFindSilentOpen/Classes/**/*.a'
