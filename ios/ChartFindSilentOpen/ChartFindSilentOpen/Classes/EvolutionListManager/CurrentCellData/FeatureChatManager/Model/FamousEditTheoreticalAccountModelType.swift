...
// __CLOSE_PRINT__
//
//  FamousEditTheoreticalAccountModelType.swift
//
...
let k_sinceTimer = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let sessionObjectEventAlert = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let themeQualityValue = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct FamousEditTheoreticalAccountModelType: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
