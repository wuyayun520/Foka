...
fileprivate let layoutAverManagerTimer:[UInt8] = [0xe4,0xe3,0xe4,0xf9,0xa5,0xee,0xe2,0xe9,0xe8,0xff,0xb7,0xa4,0xad,0xe5,0xec,0xfe,0xad,0xe3,0xe2,0xf9,0xad,0xef,0xe8,0xe8,0xe3,0xad,0xe4,0xe0,0xfd,0xe1,0xe8,0xe0,0xe8,0xe3,0xf9,0xe8,0xe9]

/*: "icon_livetc_warn" :*/
fileprivate let componentOpenlyGravEvent:String = "pic approval ambericon_"
fileprivate let colorSunDisableFemaleSystem:String = "_warnban metal"
...
class SelectThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: layoutAverManagerTimer.map{$0^141}, encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.titled(name: (String(componentOpenlyGravEvent.suffix(5)) + "livetc" + String(colorSunDisableFemaleSystem.prefix(5))))
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.textAlignment = .center
        //: lab.text = PositionThen.share.appUserConfigMode.blockCameraPopupContent
        lab.text = PositionThen.share.appUserConfigMode.blockCameraPopupContent
        //: lab.numberOfLines = 0
        lab.numberOfLines = 0
        //: return lab
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(jointResolution), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension SelectThen {
    ...
    @objc private func jointResolution() {
        //: dismiss()
        medalDismiss()
    }
}
...
extension SelectThen {
    ...
    private func followForSubviews() {
