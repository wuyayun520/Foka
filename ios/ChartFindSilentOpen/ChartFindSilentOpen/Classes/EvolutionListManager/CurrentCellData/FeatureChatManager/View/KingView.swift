...
fileprivate let screenActivityAmberId:[UInt8] = [0x46,0x4b,0x46,0x51,0x5,0x40,0x4c,0x41,0x42,0x4f,0x17,0x6,0xfd,0x45,0x3e,0x50,0xfd,0x4b,0x4c,0x51,0xfd,0x3f,0x42,0x42,0x4b,0xfd,0x46,0x4a,0x4d,0x49,0x42,0x4a,0x42,0x4b,0x51,0x42,0x41]

fileprivate func paraProblem(direction num: UInt8) -> UInt8 {
...
/*: "bg_vip" :*/
fileprivate let spacingReloadlyName:[Character] = ["b","g","_","v","i","p"]
...
class KingView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: screenActivityAmberId.map{paraProblem(direction: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.titled(name: (String(spacingReloadlyName)))
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.font = UIFont.modelSize(type: .Medium, fontSize: 15)
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(signalFee), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
