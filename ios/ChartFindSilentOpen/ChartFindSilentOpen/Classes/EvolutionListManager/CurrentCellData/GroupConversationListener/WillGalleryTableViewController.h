 ...
 *
 *  SavingDelegate 协议和 WillGalleryTableViewController 类。
 *  WillGalleryTableViewController 是聊天界面的核心类，负责聊天界面大部分核心业务逻辑的处理与运算。
 *  该类的详细属性与功能，请参展本文件中 WillGalleryTableViewController 的具体声明。
 *
 ******************************************************************************/
...
@class WillGalleryTableViewController;
//: @class FlatSolidMessageCell;
@class FlatSolidMessageCell;
//: @class ThereMessageReactiveCompatible;
@class ThereMessageReactiveCompatible;
//: @class V2TIMMessage;
@class V2TIMMessage;
...
@protocol SavingDelegate <NSObject>
...
- (void)motionWillCustom:(WillGalleryTableViewController *)controller;
...
- (void)inwardContent:(WillGalleryTableViewController *)controller;
...
- (BOOL)path:(WillGalleryTableViewController *)controller more:(UIView *)view;
 ...
 */
//: - (ThereMessageReactiveCompatible *)messageController:(TUIMessageController *)controller onNewMessage:(V2TIMMessage *)data;
- (ThereMessageReactiveCompatible *)errorMessage:(WillGalleryTableViewController *)controller brake:(V2TIMMessage *)data;
 ...
 */
//: - (FlatSolidMessageCell *)messageController:(TUIMessageController *)controller onShowMessageData:(ThereMessageReactiveCompatible *)data;
- (FlatSolidMessageCell *)activeScreen:(WillGalleryTableViewController *)controller application:(ThereMessageReactiveCompatible *)data;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageAvatar:(FlatSolidMessageCell *)cell;
- (void)available:(WillGalleryTableViewController *)controller status:(FlatSolidMessageCell *)cell;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageContent:(FlatSolidMessageCell *)cell;
- (void)media:(WillGalleryTableViewController *)controller messageStop:(FlatSolidMessageCell *)cell;
 ...
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageMenu:(NSInteger)menuType withData:(ThereMessageReactiveCompatible *)data;
- (void)info:(WillGalleryTableViewController *)controller linkController:(NSInteger)menuType textureIn:(ThereMessageReactiveCompatible *)data;
/**
...
/*重发*/
//: - (void)messageController:(TUIMessageController *)controller onRetryMessageContent:(FlatSolidMessageCell *)cell;
- (void)cur:(WillGalleryTableViewController *)controller result:(FlatSolidMessageCell *)cell;

/*引用*/
//: - (void)messageController:(TUIMessageController *)controller onReplyMessage:(ThereMessageReactiveCompatible *)cellData;
- (void)action:(WillGalleryTableViewController *)controller descriptionMessage:(ThereMessageReactiveCompatible *)cellData;

/*点击引用*/

//: - (void)messageController:(TUIMessageController *)controller onClickReplyMessage:(ThereMessageReactiveCompatible *)cellData;
- (void)active:(WillGalleryTableViewController *)controller will:(ThereMessageReactiveCompatible *)cellData;
...
/////////////////////////////////////////////////////////////////////////////////
//
//                         WillGalleryTableViewController
//
/////////////////////////////////////////////////////////////////////////////////

/**
 * 腾讯云 TUIKit
 *  【模块名称】WillGalleryTableViewController
...
@interface WillGalleryTableViewController : UITableViewController

/**
 *  执行 SavingDelegate 协议的委托
 */
//: @property (nonatomic, weak) id<TMessageControllerDelegate> delegate;
@property (nonatomic, weak) id<SavingDelegate> delegate;
 ...
 * @param uiMsgs 待删除的数据
 */
//- (void)deleteMessages:(NSArray<ThereMessageReactiveCompatible *> *)uiMsgs;
...
/**
 * 批量将V2TIMessage转换成ThereMessageReactiveCompatible
 */
