...
/******************************************************************************
 *
 *  本文件声明了 ThereMessageReactiveCompatible 类。
...
@objc public enum OrientationHashableRepresentation: UInt {
...
@objc public enum ButterflyHarvestPriorityTarget: UInt {
...
// MARK: - ThereMessageReactiveCompatible

/**
 * 【模块名称】ThereMessageReactiveCompatible
 ...
 */
//: @objcMembers public class ThereMessageReactiveCompatible: TCommonCellData {
@objcMembers public class ThereMessageReactiveCompatible: ThatReactiveCompatible {
    ...
    public var direction: ButterflyHarvestPriorityTarget = .MsgDirectionIncoming
    ...
    /// 业务消息类型
    /// messageType 消息类型：1系统消息 2官方小秘 3自动打招呼 4主动打招呼 5付费消息 6普通消息 7主动打招呼未回复 8.主打招呼回复 9，自动打招呼未回复 10, 自动打招呼回复11.发送礼物消息 12互相关注消息 13 取消关注 22家族邀请跳转消息
    ...
    public var translateStatus: OrientationHashableRepresentation = .MsgTranslate_init
    ...
    public var msgModel: StallModel = StallModel()
    ...
    public var cellLayout: ReachCompartmentCellLayout!
    ...
    public init(direction: ButterflyHarvestPriorityTarget) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.rimePecCorporate()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = ReachCompartmentCellLayout(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = ReachCompartmentCellLayout(isIncomming: false)
    ...
    public override func graphic(_ width: CGFloat) -> CGFloat {
