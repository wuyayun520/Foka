...
// __CLOSE_PRINT__
//
//  ReachCompartmentCellLayout.swift
//  ChartFindSilentOpen
//
...
@objcMembers public class ReachCompartmentCellLayout: NSObject {
    ...
    class func fullPhaseOfTheMoon() -> ReachCompartmentCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = ReachCompartmentCellLayout.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func defaultClose() -> ReachCompartmentCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = ReachCompartmentCellLayout.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func nowEditor() -> ReachCompartmentCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = ReachCompartmentCellLayout.init(isIncomming: false)
    ...
    class func message() -> ReachCompartmentCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = ReachCompartmentCellLayout.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func source() -> ReachCompartmentCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = ReachCompartmentCellLayout.init(isIncomming: false)
        //: return layout
        return layout
