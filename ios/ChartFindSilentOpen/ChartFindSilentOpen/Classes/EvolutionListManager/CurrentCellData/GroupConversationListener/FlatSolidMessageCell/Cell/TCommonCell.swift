...
@objcMembers public class ThatReactiveCompatible: NSObject {
    //: public var reuseId: String?
    public var reuseId: String?
    
    //: public func heightOfWidth(_ width: CGFloat) -> CGFloat {
    public func graphic(_ width: CGFloat) -> CGFloat {
        //: return 44
        return 44
    }
}
...
@objcMembers public class ThinViewCell: UITableViewCell {
    
    //: private(set) public var data: TCommonCellData?
    private(set) public var data: ThatReactiveCompatible?
    ...
    @objc dynamic public func minority(with data: ThatReactiveCompatible) {
        //: self.data = data
        self.data = data
    }
} 