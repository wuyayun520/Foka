...
/*!消息体数据*/
//: @class AbTalkingChatMsgInfoModel, AbTalkingChatMsgUserModel, AbTalkingChatMsgToUserModel, AbTalkingChatMsgGiftModel, AbTalkingChatMsgTipsModel, SubstanceHandyJSON, AbTalkingChatMsgIntimatePhotoModel, AbTalkingChatMsgVideoModel, AbTalkingChatMsgCustomSendModel, AbTalkingChatMsgQuoteModel, AbTalkingChatMsgQuoteDataModel, WantGiftModel;
@class TalkingStepTheoreticalAccountModel, HeavyChatModel, BowDownModel, PriceRootModel, SensualModel, SubstanceHandyJSON, HighwayModel, ResignModel, MaestroModel, MergeModel, LitModel, NutModel;

//: @interface AbTalkingChatMsgBaseModel : JSONModel
@interface StallModel : JSONModel

//: @property (nonatomic, strong)AbTalkingChatMsgInfoModel *msgInfo;
@property (nonatomic, strong)TalkingStepTheoreticalAccountModel *msgInfo;

//: @property (nonatomic, strong)AbTalkingChatMsgUserModel *user;
@property (nonatomic, strong)HeavyChatModel *user;

//: @property (nonatomic, strong)AbTalkingChatMsgToUserModel *toUser;
@property (nonatomic, strong)BowDownModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)PriceRootModel *gift;

//: @property (nonatomic, strong)AbTalkingChatMsgTipsModel *tips;
@property (nonatomic, strong)SensualModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)MergeModel *quoteMsgInfo;

//: @property (nonatomic, strong)SubstanceHandyJSON *userInfoModel;
@property (nonatomic, strong)SubstanceHandyJSON *userInfoModel;
...
@interface TalkingStepTheoreticalAccountModel : JSONModel
...
@property (nonatomic, strong) HighwayModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) ResignModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) MaestroModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) NutModel *wantGift; /// 想要礼物
...
@interface HighwayModel : JSONModel
...
@interface ResignModel: JSONModel
...
@interface MaestroModel: JSONModel
...
@interface HeavyChatModel : JSONModel
...
@interface BowDownModel : JSONModel
...
@interface PriceRootModel : JSONModel
...
@interface SensualModel : JSONModel
...
@interface MergeModel : JSONModel
...
@property (nonatomic, strong) LitModel *renderData;
