...
fileprivate let layoutSumryAddSession:[UInt8] = [0x9c,0x9b,0x9c,0x81,0xdd,0x96,0x9a,0x91,0x90,0x87,0xcf,0xdc,0xd5,0x9d,0x94,0x86,0xd5,0x9b,0x9a,0x81,0xd5,0x97,0x90,0x90,0x9b,0xd5,0x9c,0x98,0x85,0x99,0x90,0x98,0x90,0x9b,0x81,0x90,0x91]
...
class ShieldView: UIView {
    ...
    class func giftCreate(_ frame: CGRect) -> UIView {
        //: return MAScreenShieldView(frame: frame)
        return ShieldView(frame: frame)
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: layoutSumryAddSession.map{$0^245}, encoding: .utf8)!)
    }
