...
/*: ".png" :*/
fileprivate let viewHumanId:String = ".pngwho perform ad woman"
...
// __CLOSE_PRINT__
//
//  SinceFamousReactiveCompatible.swift
//  AbroadTalking
//
...
//: @objcMembers public class SinceFamousReactiveCompatible: TalkingChatMsgBaseCellData {
@objcMembers public class SinceFamousReactiveCompatible: CrashCellData {
    ...
    override public var msgModel: StallModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.bodyOfWork(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func nextImage(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(kProgressTimer)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + PositionThen.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + PositionThen.share.loginUserMode.userID + (String(viewHumanId.prefix(4)))
        ...
        let imageData = UIImage.enter(image, read: 2 * 1024)
