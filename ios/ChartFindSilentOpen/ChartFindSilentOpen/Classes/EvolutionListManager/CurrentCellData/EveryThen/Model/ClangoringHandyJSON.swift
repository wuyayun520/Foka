...
struct MassMeasurable: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var messageType = 0
...
struct FrameworkTransformable: HandyJSON {
    //: var uid = 0
    var uid = 0
    //: var nickname = ""
    var nickname = ""
