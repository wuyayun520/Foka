...
class TalkingMeasurable: HandyJSON {
    //: var uid = 0
    var uid = 0
    //: var headPic = ""
    var headPic = ""
...
class PointHandyJSON: HandyJSON {
    //: var name = ""
    var name = ""
    //: var icon = ""
    var icon = ""
