...
open class CircleMapTextView: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = CircleMapTextView.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
