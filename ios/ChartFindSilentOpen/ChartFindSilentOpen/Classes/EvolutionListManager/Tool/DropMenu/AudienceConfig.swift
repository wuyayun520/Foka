...
public enum TermHarvestMenuStyle {
  //: case MenuDarkStyle 
...
public struct Config {
    ...
    public static var initialMenuStyle: TermHarvestMenuStyle?

    
    //: public struct MenuCellConfig {        
    public struct RoyalFamilyScreen {        
