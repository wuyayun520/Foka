...
fileprivate let sessionInnerSystem:[UInt8] = [0x81,0x86,0x81,0x8c,0x40,0x7b,0x87,0x7c,0x7d,0x8a,0x52,0x41,0x38,0x80,0x79,0x8b,0x38,0x86,0x87,0x8c,0x38,0x7a,0x7d,0x7d,0x86,0x38,0x81,0x85,0x88,0x84,0x7d,0x85,0x7d,0x86,0x8c,0x7d,0x7c]

fileprivate func rowPin(from num: UInt8) -> UInt8 {
...
class ReverseView: UITableViewCell {
    //: lazy var menuImageView: UIImageView = self.makeMenuImageView()
    lazy var menuImageView: UIImageView = self.input()
    //: lazy var menuTitleLabel: UILabel = self.makeMenuTitleLable()
    lazy var menuTitleLabel: UILabel = self.atChecked()
    ...
    var menuModel: ConversionMenuModel? {
        //: didSet {
        didSet {
    ...
    var dropMenuStyle: TermHarvestMenuStyle? {
        //: didSet {
        didSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: sessionInnerSystem.map{rowPin(from: $0)}, encoding: .utf8)!)
    }
    ...
    private func input() -> UIImageView {
    ...
    private func atChecked() -> UILabel {
    ...
    private func thin() {
        ...
        lineLayer.strokeColor = UIColor.childMagnitude(230, 230, 230, 1.0).cgColor
