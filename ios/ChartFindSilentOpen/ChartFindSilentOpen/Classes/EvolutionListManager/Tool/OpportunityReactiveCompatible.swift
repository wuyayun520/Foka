...
/*: "App" :*/
fileprivate let viewMarginError:String = "guard delivery short shirtApp"

/*: "blockList_ :*/
fileprivate let styleNarrowSecureUtility:String = "tolerance"
fileprivate let styleAddedMetrics:[Character] = ["l","o","c","k","L","i","s","t","_"]
...
// __CLOSE_PRINT__
//
//  OpportunityReactiveCompatible.swift
//  AbroadTalking
//
...
class OpportunityReactiveCompatible: NSObject {
    //: var blockList: [String]?
    var blockList: [String]? // 拉黑列表

    // singleton
    //: static let shared = TalkingBlockListManager()
    static let shared = OpportunityReactiveCompatible()
    ...
    func burnConstraint(userId: String) -> Bool {
    ...
    private func labelElement() -> String {
        //: let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        //: let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent("App")
        let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent((String(viewMarginError.suffix(3))))
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((styleNarrowSecureUtility.replacingOccurrences(of: "tolerance", with: "b") + String(styleAddedMetrics)) + "\(uid)")
        //: return filePath
        return filePath
    }
}
