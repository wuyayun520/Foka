...
fileprivate let serviceActivityError:[UInt8] = [0x9b,0x9c,0x9b,0x86,0xda,0x91,0x9d,0x96,0x97,0x80,0xc8,0xdb,0xd2,0x9a,0x93,0x81,0xd2,0x9c,0x9d,0x86,0xd2,0x90,0x97,0x97,0x9c,0xd2,0x9b,0x9f,0x82,0x9e,0x97,0x9f,0x97,0x9c,0x86,0x97,0x96]

private func noLess(meet num: UInt8) -> UInt8 {
    return num ^ 242
}
...
class AnimationThen: SpecifySizeThen {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: serviceActivityError.map{noLess(meet: $0)}, encoding: .utf8)!)
    }
    ...
    override func actionFail() {
        ...
        let filePath = SinceAnimatTool.shared.listen(fileName: (self.giftEffectModel?.mainFile)!, model: self.effectMsgModel!)
        ...
        parser?.parse(with: data! as Data, cacheKey: key, completionBlock: { [weak self] videoItem in
            ...
            self.delegate?.rollAround(effectItemView: self, success: true)
...
extension AnimationThen: SVGAPlayerDelegate {
