...
class CurrentAcidTool: NSObject {
...
extension CurrentAcidTool {
    ...
    func promotion(_ frontCamera: Bool) {
        ...
        self.propRoot(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func singleHem(_ openCamera: Bool) {
        ...
        self.discourse(isOpen: openCamera)
    }
    ...
    func asMinimize() {
        ...
        DispatchQueue.main.async {
            ...
            self.displayButtonAgent(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension CurrentAcidTool {
    ...
    private func propRoot(front: Bool) {
    ...
    private func discourse(isOpen: Bool) {
        //: guard SenseTime_Use == true else {
        guard kVoiceMicPathContent == true else {
            //: if isOpen {
            if isOpen {
...
extension CurrentAcidTool {
    ...
    func everyLaunch() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(invade(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(scopeRecent(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(beanBoard(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(magnitudeerpret(notif:)),
    ...
    @objc private func invade(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func scopeRecent(notif: Notification?) {
        //: if notif == nil { 
    ...
    @objc private func beanBoard(notif: Notification) {
    ...
    @objc func magnitudeerpret(notif: Notification) {
...
extension CurrentAcidTool {
    ...
    func getMoving() {
        ...
        if self.infoModel?.videoStage == .Waiting {
            ...
            displayButtonAgent(smallWindow: false)
        ...
        //: } else if self.infoModel?.videoStage == .Calling {
            ...
            //: } else {
                ...
                displayButtonAgent(smallWindow: true)
            }
        }
    ...
    func displayButtonAgent(smallWindow: Bool) {
        //: guard SenseTime_Use == true else {
        guard kVoiceMicPathContent == true else {
