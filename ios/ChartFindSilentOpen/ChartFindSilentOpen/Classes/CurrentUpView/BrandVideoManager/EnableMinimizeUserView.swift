...
/*: "icon_randow_user_bg" :*/
fileprivate let viewRegulationKey:[Character] = ["i","c","o","n","_","r","a","n","d","o","w"]
fileprivate let componentTimberError:[Character] = ["_","u","s","e","r","_","b","g"]
...
class EnableMinimizeUserView: UIView {
    // MARK: - UI Components

    //: private let leftAvatarView = AvatarView()
    private let leftAvatarView = PushHereThen()
    //: private let centerAvatarView = AvatarView()
    private let centerAvatarView = PushHereThen()
    //: private let rightAvatarView = AvatarView()
    private let rightAvatarView = PushHereThen()
    ...
    private func picture() {
        ...
        centerBgView.image = UIImage.titled(name: (String(viewRegulationKey) + String(componentTimberError)))
    }
...
extension EnableMinimizeUserView {
    // MARK: - Public Methods

    //: func configure(avatars: [String]) {
    func personAvatars(avatars: [String]) {
...
class PushHereThen: UIView {
    ...
    private func keyKeep() {
        //: imageView.setUrlImage(urlStr: self.imageurl ?? "")
        imageView.imitation(urlStr: self.imageurl ?? "")
    }
}
