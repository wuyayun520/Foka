...
/*: "#777777" :*/
fileprivate let screenIllegalKey:[Character] = ["#","7","7","7","7","7","7"]

/*: "#333333" :*/
fileprivate let k_butTitle:String = "#33333"
fileprivate let moduleCloudConfig:[Character] = ["3"]

/*: "Search" :*/
fileprivate let viewBladeData:String = "pad reminderSearch"

/*: "Details" :*/
fileprivate let moduleCurveAlert:String = "highlight highlightDetails"

/*: "nav_back_black_nor" :*/
fileprivate let componentBurnUtility:String = "enhance channel betweennav_ba"
fileprivate let spacingStatPlatform:String = "devote day tremendousack_nor"
...
class FluReactiveCompatible: GroupThen {
    ...
    private lazy var categoryView: JXSegmentedView = {
        ...
        segmentedDataSource.titleNormalColor = UIColor(hex: (String(screenIllegalKey)))!
        //: segmentedDataSource.titleSelectedColor = UIColor.init(hex: "#333333")!
        segmentedDataSource.titleSelectedColor = UIColor(hex: (k_butTitle.capitalized + String(moduleCloudConfig)))!
        ...
        indicator.indicatorColor = UIColor(hex: (k_butTitle.capitalized + String(moduleCloudConfig)))!
...
//        view.defaultSelectedIndex = currentIndex
    ...
    private lazy var titleArray: [String] = //: return ["Search".localized, "Details".localized]
        [(String(viewBladeData.suffix(6))).localized, (String(moduleCurveAlert.suffix(7))).localized]
    //: }()

    //: private lazy var dataVC: [TalkingBaseViewController] = {
    private lazy var dataVC: [GroupThen] = //: return [DecisionViewController(), PackageParaObjectProtocol()]
        [DecisionViewController(), PackageParaObjectProtocol()]
    //: }()
    ...
    private lazy var backButton: UIButton = {
        ...
        let img = UIImage.titled(name: (String(componentBurnUtility.suffix(6)) + "ck_bl" + String(spacingStatPlatform.suffix(7)))).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .black
        btn.tintColor = .black
        //: btn.addTarget(self, action: #selector(backButtonClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(backBuilderClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension FluReactiveCompatible: JXSegmentedViewDelegate {
...
extension FluReactiveCompatible: JXPagingViewDelegate {
...
extension FluReactiveCompatible {
    /// 返回按钮事件
    //: @objc private func backButtonClick() {
    @objc private func backBuilderClick() {
