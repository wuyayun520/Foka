...
fileprivate let coreMeanwhileContent:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_lounge" :*/
fileprivate let layoutPartyMetrics:[Character] = ["i","c","o","n","_","l","o","u","n","g","e"]

/*: "#777777" :*/
fileprivate let viewWritHelper:String = "#fragmentfragmentfragment"

/*: "UID: :*/
fileprivate let spacingAspectConfig:String = "UID:motion version error dangerous"
...
class AboardView: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: coreMeanwhileContent.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.titled(name: (String(layoutPartyMetrics)))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.font = UIFont.modelSize(type: .Regular, fontSize: 15)
        //: lab.textColor = UIColor(hex: "#777777")
        lab.textColor = UIColor(hex: (viewWritHelper.replacingOccurrences(of: "fragment", with: "77")))
        //: return lab
        return lab
        //: }()
    }()
...
extension AboardView {
    ...
    func exist(model: SauceUserModel) {
        //: headPicImgV.setUrlImage(urlStr: model.headPic)
        headPicImgV.imitation(urlStr: model.headPic)
        //: nicknameLab.textColor = model.loungePlus ? .userVipColor():.appTitleColor()
        nicknameLab.textColor = model.loungePlus ? .birthControl() : .restoreAudience()
        //: nicknameLab.text = model.nickname
        nicknameLab.text = model.nickname
        //: uidLab.text = "UID:\(model.uid)"
        uidLab.text = (String(spacingAspectConfig.prefix(4))) + "\(model.uid)"
