...
/*: "Face verification" :*/
fileprivate let colorIncorporateFormat:String = "Face vtop privacy feed mid general"
fileprivate let kSafetyId:[Character] = ["a","t","i","o","n"]
...
class ThereVerificationThen: GroupThen {
    ...
    override func viewDidLoad() {
        ...
        title = (String(colorIncorporateFormat.prefix(6)) + "erific" + String(kSafetyId)).localized
        //: self.createUI()
        self.homeUi()
        //: self.createUIConstraint()
        self.limitConstraint()
    }

    // MARK: - Lazy load

    //: lazy var mainView: TalkingVerificationExampleView = {
    lazy var mainView: AlongsidePoetThen = {
        //: let view = TalkingVerificationExampleView()
        let view = AlongsidePoetThen()
        //: return view
        return view
        //: }()
    }()
...
extension ThereVerificationThen: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
        ...
        self.dismiss(animated: true) {
            ...
            if let photo = info[UIImagePickerController.InfoKey.originalImage] as? UIImage {
                ...
                if self.isRegisterPush {
                    ...
                    let vc = FluViewController(photoImage: photo)
...
extension ThereVerificationThen {
    ...
    func homeUi() {
        ...
        mainView.btnClickBlock = { [weak self] () in
            ...
            MagnitudeReactiveCompatible.pry(true) { isOpen in
