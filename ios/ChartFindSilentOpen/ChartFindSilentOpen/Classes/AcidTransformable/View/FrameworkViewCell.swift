...
fileprivate let k_interactionData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "btn_me_edit" :*/
fileprivate let kBounceFormat:String = "btn_mgallery sight import transform transfer"

/*: "Add" :*/
fileprivate let viewMedalPreference:[Character] = ["A","d","d"]
...
class FrameworkViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_interactionData.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.titled(name: (String(kBounceFormat.prefix(5)) + "e_edit")))
    ...
    lazy var detailLB: UILabel = {
        ...
        lb.text = (String(viewMedalPreference)).localized
        //: lb.isHidden = true
        lb.isHidden = true
        //: return lb
        return lb
