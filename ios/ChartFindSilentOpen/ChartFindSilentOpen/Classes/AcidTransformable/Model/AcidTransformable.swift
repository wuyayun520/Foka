...
struct AcidTransformable: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: ReferentMeasurable?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [MapMeasurable]? // 相册
    ...
    var aiExtraInfo = RecallInfoModel() // AI模型
    //: var vipSkinId = 0
...
struct ReferentMeasurable: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
    //: var list: Array<TalkingUserInfoMomentItemModel>?
    var list: [SecondMeasurable]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct SecondMeasurable: HandyJSON {
...
struct MapMeasurable: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func saloonKeeper(compareTo: MapMeasurable) -> Bool {
        //: return
        return
...
struct RecallInfoModel: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
