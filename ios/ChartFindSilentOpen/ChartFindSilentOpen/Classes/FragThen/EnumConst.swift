...
enum SignatureHashableRepresentation: Int {
    //: case Social  = 0
    case Social = 0 // 交友
    //: case Moment  = 1
    case Moment = 1 // 动态
...
enum ExpectUTF8Initializable: String {
    //: case AppleLogin
...
enum DemythologizedRepresentable: Int {
    //: case Normal         = 0
    case Normal = 0
    //: case NetError       = -10000
...
/// 性别
//: enum Gender: String {
enum PanelScalarLiteral: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum SwineInfluenzaSubscriptType: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum ScreenUTF8Initializable: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum ConversionAdditiveArithmetic: Int {
    //: case unknown    = 0
    case unknown = 0
    //: case social     = 1
    case social = 1 // 社交礼物
...
@objc public enum SpringAlongsidePriorityTarget: Int {
    //: case Unavailable = 0
...
enum PanelQuantityerventionCellType: CaseIterable {
