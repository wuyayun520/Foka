...
fileprivate let appGuidelinePlatform:String = "decide analysisbtn_m"
fileprivate let kDigPromptText:String = "ck_colive town"
fileprivate let commonRackHelper:String = "ntaimnue"

/*: "init(coder:) has not been implemented" :*/
fileprivate let viewAppropriateHelper:[UInt8] = [0x3d,0x3a,0x3d,0x20,0x7c,0x37,0x3b,0x30,0x31,0x26,0x6e,0x7d,0x74,0x3c,0x35,0x27,0x74,0x3a,0x3b,0x20,0x74,0x36,0x31,0x31,0x3a,0x74,0x3d,0x39,0x24,0x38,0x31,0x39,0x31,0x3a,0x20,0x31,0x30]
...
class AcidReactiveCompatible: UIView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(opClick), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(admittance), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: FeatureAlertConfig)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (String(appGuidelinePlatform.suffix(5)) + "e_ba" + String(kDigPromptText.prefix(5)) + commonRackHelper.replacingOccurrences(of: "aim", with: "i"))
        }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: viewAppropriateHelper.map{$0^84}, encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func headingOccur(title: String, isTouch: Bool) {
