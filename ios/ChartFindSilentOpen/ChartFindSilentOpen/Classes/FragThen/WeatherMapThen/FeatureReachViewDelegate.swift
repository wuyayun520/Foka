...
// __CLOSE_PRINT__
//
//  FeatureReachViewDelegate.swift
//  FeatureReachViewDelegate
...
class FeatureReachViewDelegate: UIView {
    // MARK: - 懒加载属性
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        enableCorporate(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        enableCorporate(placeholder: nil, placeholderColor: nil)
    }
}
...
extension FeatureReachViewDelegate {
    /// placeholder Label Setup
    //: private func setup(placeholder: String?, placeholderColor: UIColor?) {
    private func enableCorporate(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(KingSpecifyLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(KingSpecifyLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-KingSpecifyLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: UnfoldContainerInset().top, left: UnfoldContainerInset().left, bottom: UnfoldContainerInset().bottom, right: UnfoldContainerInset().right)
...
extension FeatureReachViewDelegate: UITextViewDelegate {
...
extension FeatureReachViewDelegate {
    ...
    private func privacyPlaceholder() {
