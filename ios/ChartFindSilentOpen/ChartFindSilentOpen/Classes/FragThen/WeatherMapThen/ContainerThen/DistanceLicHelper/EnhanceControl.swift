...
/*: "st_slider_thumb" :*/
fileprivate let spacingUtterConfig:String = "play terriblest_sli"
fileprivate let sessionChartName:String = "THUMB"

/*: "init(coder:) has not been implemented" :*/
fileprivate let viewMeatSureHelper:[UInt8] = [0xa1,0xa6,0xa1,0xac,0x60,0x9b,0xa7,0x9c,0x9d,0xaa,0x72,0x61,0x58,0xa0,0x99,0xab,0x58,0xa6,0xa7,0xac,0x58,0x9a,0x9d,0x9d,0xa6,0x58,0xa1,0xa5,0xa8,0xa4,0x9d,0xa5,0x9d,0xa6,0xac,0x9d,0x9c]

fileprivate func infoSleeve(data num: UInt8) -> UInt8 {
...
class EnhanceControl: UISlider {
    ...
    override var currentThumbImage: UIImage? {
        ...
        get {
            ...
            return UIImage.titled(name: (String(spacingUtterConfig.suffix(6)) + "der_" + sessionChartName.lowercased()))
        }
        //: set {
        set {}
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: viewMeatSureHelper.map{infoSleeve(data: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var valueView: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.modelSize(type: .Regular, fontSize: 12)
