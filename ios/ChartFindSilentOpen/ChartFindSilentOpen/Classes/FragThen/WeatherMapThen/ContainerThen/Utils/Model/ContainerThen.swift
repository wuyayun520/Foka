...
//: @objcMembers public class ContainerThen: JSONModel {
@objcMembers public class ContainerThen: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = BeautyComparable.Face
...
//: @objc extension ContainerThen {
@objc extension ContainerThen {
    //: func initWith(suiteType: BeautyItemType)-> ContainerThen {
    func birthType(suiteType: BeautyComparable) -> ContainerThen {
        //: let model = ContainerThen.init()
        let model = ContainerThen()
