...
class BetterView: UILabel {
    ...
    //: private func setup() {
    private func endAver() {
        //: translatesAutoresizingMaskIntoConstraints = false
        translatesAutoresizingMaskIntoConstraints = false
        //: layer.backgroundColor = UIColor.msgTipsColor().cgColor
        layer.backgroundColor = UIColor.lean().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.pingfangFont(type: .Medium, fontSize: 11)
        font = UIFont.modelSize(type: .Medium, fontSize: 11)
...
class TextReactiveCompatible: UILabel {
