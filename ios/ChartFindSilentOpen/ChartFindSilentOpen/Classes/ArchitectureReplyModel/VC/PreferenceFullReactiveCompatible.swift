...
// __CLOSE_PRINT__
//
//  PreferenceFullReactiveCompatible.swift
//  AbroadTalking
//
...
class PreferenceFullReactiveCompatible: GroupThen {
    ...
    lazy var topView: SpecifyReactiveCompatible = {
        //: let view = TalkingMomentPhotosTopView(frame: CGRect.zero, type: myType ?? .normal)
        let view = SpecifyReactiveCompatible(frame: CGRect.zero, type: myType ?? .normal)
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var bottomView: EarnQueryReactiveCompatible = {
    ...
    lazy var usePhotoView: SauceThen = {
        //: let v = TalkingSendIntimateInfoView(frame: CGRect.zero, type: .intimatePhoto)
        let v = SauceThen(frame: CGRect.zero, type: .intimatePhoto)
        //: return v
        return v
        //: }()
    }()
...
extension PreferenceFullReactiveCompatible {
    //: func crushBtnTool(modle: TalkingMomentModel) {
    func doDisableDirect(modle: NothingMeasurable) {
        ...
        if modle.sex == nil {
            ...
            //: bottomView.isHidden = modle.sex==PositionThen.share.loginUserMode.sex
            bottomView.isHidden = modle.sex == PositionThen.share.loginUserMode.sex
        }
