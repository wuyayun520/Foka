...
fileprivate let sessionVerticalFormat:[UInt8] = [0xda,0xdd,0xda,0xc7,0x9b,0xd0,0xdc,0xd7,0xd6,0xc1,0x89,0x9a,0x93,0xdb,0xd2,0xc0,0x93,0xdd,0xdc,0xc7,0x93,0xd1,0xd6,0xd6,0xdd,0x93,0xda,0xde,0xc3,0xdf,0xd6,0xde,0xd6,0xdd,0xc7,0xd6,0xd7]

private func photoAchievement(host num: UInt8) -> UInt8 {
    return num ^ 179
}
...
// __CLOSE_PRINT__
//
//  ConversionReactiveCompatible.swift
//  AbroadTalking
//
...
class ConversionReactiveCompatible: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: sessionVerticalFormat.map{photoAchievement(host: $0)}, encoding: .utf8)!)
    }
...
extension ConversionReactiveCompatible {
    /// 更新进度
    /// - Parameter percent: 进度
    //: func updatePercent(percent: CGFloat) {
    func enableAnnouncement(percent: CGFloat) {
