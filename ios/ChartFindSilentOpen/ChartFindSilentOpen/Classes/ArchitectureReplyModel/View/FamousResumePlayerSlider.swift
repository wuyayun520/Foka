...
fileprivate let themeMoteAlert:[UInt8] = [0xe3,0xe4,0xe3,0xfe,0xa2,0xe9,0xe5,0xee,0xef,0xf8,0xb0,0xa3,0xaa,0xe2,0xeb,0xf9,0xaa,0xe4,0xe5,0xfe,0xaa,0xe8,0xef,0xef,0xe4,0xaa,0xe3,0xe7,0xfa,0xe6,0xef,0xe7,0xef,0xe4,0xfe,0xef,0xee]
...
// __CLOSE_PRINT__
//
//  FamousResumePlayerSlider.swift
//  AbroadTalking
//
...
class FamousResumePlayerSlider: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: themeMoteAlert.map{$0^138}, encoding: .utf8)!)
    }
    ...
    private lazy var progressView: ArchitectureProgressView = {
        ...
        let v = ArchitectureProgressView(frame: self.frame, progressBgColor: self.progressBgColor, progressPlayedColor: self.progressPlayedColor, progressCachedColor: self.progressCachedColor)
    ...
    private lazy var panGesture: UIPanGestureRecognizer = {
        ...
        let v = UIPanGestureRecognizer(target: self, action: #selector(logical(gesture:)))
        //: return v
        return v
        //: }()
    }()
    ...
    private lazy var tapGesture: UIPanGestureRecognizer = {
        ...
        let v = UIPanGestureRecognizer(target: self, action: #selector(us(gesture:)))
        //: return v
        return v
        //: }()
    }()
...
extension FamousResumePlayerSlider {
    //: @objc func panGesture(gesture: UIPanGestureRecognizer) {
    @objc func logical(gesture: UIPanGestureRecognizer) {
        // 移动的距离
    ...
    @objc func us(gesture: UIPanGestureRecognizer) {
