...
/*: "nav_back_black_nor" :*/
fileprivate let displayFitSpreadSomethingSystem:[Character] = ["n","a","v","_","b","a","c","k","_","b","l","a","c","k"]
fileprivate let sessionReasonUtility:String = "come layer acquire pow para_nor"

/*: "Email Address" :*/
fileprivate let modulePrepareLureValue:String = "Email Adinterval warning"
fileprivate let colorQuoteExceptError:[Character] = ["d","r","e","s","s"]

/*: "F4F6FA" :*/
fileprivate let colorMultiPage:String = "F4Feast"
fileprivate let k_varyManageConfig:[Character] = ["A"]

/*: "Add an email address" :*/
fileprivate let viewPackageDigPage:String = "wide whenAdd a"
fileprivate let screenSpendSettings:String = "chance tot assert remindl addre"
fileprivate let colorEaveKey:String = "lack"

/*: "BBBBBB" :*/
fileprivate let coreDueSettings:String = "differencedifferencedifference"

/*: "Only you will see your email on your profile." :*/
fileprivate let screenRemainMessage:[UInt8] = [0xaa,0x8b,0x89,0x9c,0xc5,0x9c,0x8a,0x90,0xc5,0x92,0x8c,0x89,0x89,0xc5,0x96,0x80,0x80,0xc5,0x9c,0x8a,0x90,0x97,0xc5,0x80,0x88,0x84,0x8c,0x89,0xc5,0x8a,0x8b,0xc5,0x9c,0x8a,0x90,0x97,0xc5,0x95,0x97,0x8a,0x83,0x8c,0x89,0x80,0xcb]

/*: "Send verification email" :*/
fileprivate let screenDealSettings:String = "tern bodySend"
fileprivate let viewPeopleValue:String = "ihaveca"
fileprivate let colorApprovalDevice:String = "tion ehear pause reply guarantee fruit"
...
class PromiseEmailVc: GroupThen {
    // 是否展示返回按钮
    //: var isBack = true
    var isBack = true
    ...
    private lazy var backBtn: UIButton = {
        ...
        btn.setImage(UIImage.titled(name: (String(displayFitSpreadSomethingSystem) + String(sessionReasonUtility.suffix(4)))), for: .normal)
        //: btn.addTarget(self, action: #selector(backBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(southwest), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.font = .modelSize(type: .Semibold, fontSize: 17.0)
        //: label.textColor = .appTitleColor()
        label.textColor = .restoreAudience()
        //: label.textAlignment = .center
        label.textAlignment = .center
        //: label.text = "Email Address".localized
        label.text = (String(modulePrepareLureValue.prefix(8)) + String(colorQuoteExceptError)).localized
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var emailInputView: UITextField = {
        ...
        textField.backgroundColor = UIColor(hex: (colorMultiPage.replacingOccurrences(of: "east", with: "6F") + String(k_varyManageConfig)))
        ...
        textField.attributedPlaceholder = NSAttributedString(string: (String(viewPackageDigPage.suffix(5)) + "n emai" + String(screenSpendSettings.suffix(7)) + colorEaveKey.replacingOccurrences(of: "lack", with: "ss")).localized, attributes: [NSAttributedString.Key.font: UIFont.modelSize(type: .Regular, fontSize: 15), NSAttributedString.Key.foregroundColor: UIColor(hex: (coreDueSettings.replacingOccurrences(of: "difference", with: "BB")))!])
    ...
    private lazy var emailTipLabel: UILabel = {
        ...
        label.font = .modelSize(type: .Regular, fontSize: 15.0)
        ...
        label.text = String(bytes: screenRemainMessage.map{$0^229}, encoding: .utf8)!.localized
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var commitButton: UIButton = {
        ...
        btn.setTitle((String(screenDealSettings.suffix(4)) + " ver" + viewPeopleValue.replacingOccurrences(of: "have", with: "fi") + String(colorApprovalDevice.prefix(6)) + "mail").localized, for: .normal)
...
extension PromiseEmailVc {
    ...
    func red() {
        ...
        ScriptReactiveCompatible.face(emailStr: emailInputView.text!, isBind: true) { succeed, _, _ in
            //: ProgressHUD.dismiss()
