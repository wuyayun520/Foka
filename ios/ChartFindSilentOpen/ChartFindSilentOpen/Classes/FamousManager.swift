...
/*: "&sr=6" :*/
fileprivate let componentHighlightMetrics:[Character] = ["&","s","r","=","6"]
...
enum ButterflyKeyRepresentable: String, CaseIterable {
...
enum AntitypeTitleCounterpolation: String {
...
class FamousManager: NSObject {
    ...
    class func putBack(urlType: AntitypeTitleCounterpolation) -> String {
        //: var url = PositionThen.share.appConfigMode.urlH5Domain
        var url = PositionThen.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(PositionThen.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : PositionThen.share.appUserConfigMode.fullRechargePage)
            url.append(PositionThen.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : PositionThen.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(PositionThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : PositionThen.share.appUserConfigMode.halfRechargePage)
            url.append(PositionThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : PositionThen.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = PositionThen.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = PositionThen.share.appUserConfigMode.halfRechargePage.appending((String(componentHighlightMetrics)))
            //: url.append(PositionThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(PositionThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
